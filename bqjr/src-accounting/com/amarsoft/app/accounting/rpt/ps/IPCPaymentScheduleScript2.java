...
public class IPCPaymentScheduleScript2 implements IPaymentScheduleScript{
	...
	public List<BusinessObject> createPaymentScheduleList(BusinessObject loan,String toDate,AbstractBusinessObjectManager bom) throws Exception {
		...
		double installmentAmt = this.getInstallmentAmt(loanTemp, paymentScheduleList);
	...
	private double getInstallmentAmt(BusinessObject loan,List<BusinessObject> paymentScheduleList)  throws Exception{
		double installmentAmt=0d;
		double principalBalance = AccountCodeConfig.getBusinessObjectBalance(loan, "AccountCodeNo",ACCOUNT_CONSTANTS.LOAN_BalanceGroup_Customer_Normal_Principal
				,ACCOUNT_CONSTANTS.Balance_Flag_CurrentDay);
