package com.amarsoft.app.accounting.trans.script.loan.loanextendchange;
...
public class LoanExtendChangeExecutor implements ITransactionExecutor{
	...
	public int execute(String scriptID,ITransactionScript transactionScript) throws Exception {
		...
		//更新贷款利率
		updateRateSegment(rateList, newRateList, loan);
		//更新罚息利率
	...
	//更新
	private void updateRateSegment(List<BusinessObject> rateList,List<BusinessObject> newRateList,BusinessObject loan) throws  Exception{
		AbstractBusinessObjectManager boManager = transactionScript.getBOManager();
		//对旧利率处理
