...
/* 	sTemp.append("<tr>");
	...
	sTemp.append("<td colspan=5 align=left class=td1 >48.开户银行：<br>&nbsp;&nbsp;&nbsp;&nbsp;招商银行深圳四海支行 &nbsp;</td>");
	...
	sTemp.append("<br />本人保证在此表上填写、确认的内容及向贷款人、担保人和客户服务供应商提供的所有相关资料全部真实、有效，如本人提供虚假资料，将承担由此引起的一切责任及损失。本人在此同意贷款人及担保人和客户服务供应商按照相关法律法规的规定，向有权机构报送本人的个人信用信息，包括但不限于本申请表项下的信息，同时，授权贷款人及担保人和客户服务供应商向任何可能的来源查询本人及配偶的与贷款申请有关的个人信息和个人信用信息，相关查询结果的用途将用于贷款审查和贷款管理。");
	sTemp.append("<br />本人同意如因单方面取消申请或不具备借款条件，申请不获批准，本表格及所有已提交的资料无须退还本人，由担保人处理。贷款人及担保人有权拒绝本贷款申请而无须给予任何原因解释。</p>");
	sTemp.append("</td>");
	sTemp.append("</tr>");
