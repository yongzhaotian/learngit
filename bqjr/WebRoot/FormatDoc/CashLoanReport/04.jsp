...
ASResultSet rs2 = Sqlca.getResultSet(sSql);
	if(rs2.next()){
		...
		sReplaceAccount = rs2.getString("ReplaceAccount");//账号
		sReplaceName = rs2.getString("ReplaceName");//账户名
		sOpenBankName=rs2.getString("OpenBank");  //开户行
...
<%
	...
	sTemp.append("<tr style='height:50px; border: none;'>");
	//sTemp.append("<td colspan=3 width='30%' class=td1 style='border: none;'><font style=' font-size: 8pt; text-align: left;margin: auto;' >协议签署日："+DateX.format(new java.util.Date(),"yyyy/MM/dd HH:mm:ss")+"</td>");
	sTemp.append("<td colspan=7 width='70%' class=td1 style='border: none;'><font style=' font-size: 8pt; text-align: center;margin: auto;' >协议签署地：广东省深圳市前海深港合作区</td>");
