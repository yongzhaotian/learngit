...
<%
	...
	ASResultSet rs2 = Sqlca.getResultSet("select getItemName('OccurType',OccurType) as OccurTypeName," +
	...
	while(rs2.next())
	{
		sOccurTypeName = rs2.getString("OccurTypeName");
		...
		sBalanceSum = DataConvert.toMoney(rs2.getDouble("Balance")/10000);
		if (sBalanceSum == null) sBalanceSum = "";
		
		dBalanceSum = rs2.getDouble("Balance");
		...
		sTemp.append("   <td width=8% align=center class=td1 >"+sCurrencyName+"&nbsp;</td>");
