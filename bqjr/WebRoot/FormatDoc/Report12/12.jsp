...
<%
	...
	sTemp.append("   <td class=td1 colspan=8 bgcolor=#aaaaaa ><font style=' font-size: 16pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >"+sBankName+"审批意见</font></td>"); 	
	sTemp.append("   </tr>");
	sTemp.append("   <tr align=right>");	
	sTemp.append("   <td colspan=8 bgcolor=#aaaaaa class=td1 ><font style=' font-size: 12pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >审批意见编号："+sObjectNo+"</font></td>"); 	
    sTemp.append("   </tr>");		
	sTemp.append("   <tr>");
    ...
    */
	...
	sTemp.append("   <td width=14% align=center class=td1 ><font style=' font-size: 12pt;FONT-FAMILY:宋体;'>抵质押物</font></td>");
    ...
    sTemp.append("   <tr>");
    sTemp.append("   <td colspan=8 align=center class=td1 ><font style=' font-size: 16pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;' >&nbsp;审&nbsp;批&nbsp;意&nbsp;见&nbsp;</font></td>");
	sTemp.append("   </tr>");
    sTemp.append("   <tr>");
	sTemp.append("   <td colspan=8 align=left class=td1 style='word-break:break-all' ><font style=' font-size: 12pt;FONT-FAMILY:宋体;'><br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;审批人：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;审批日期：</font></td>");
    sTemp.append("   </tr>");
	sTemp.append("</table>");	
	sTemp.append("</div>");	
