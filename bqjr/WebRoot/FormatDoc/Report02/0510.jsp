...
<%
	...
	sTemp.append("<form method='post' action='0510.jsp' name='reportInfo'>");	
	sTemp.append("<div id=reporttable>");	
	sTemp.append("<table class=table1 width='640' align=center border=1 cellspacing=0 cellpadding=2 bgcolor=white bordercolor=black bordercolordark=black >	");
	sTemp.append("   <tr>");	
	sTemp.append("   <td class=td1 align=left bgcolor=#aaaaaa ><font style=' font-size: 12pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >5.10、申请人财务总体评价</font></td>"); 	
	sTemp.append("   </tr>");	
	sTemp.append("   <tr>");
  	sTemp.append("<td align=left class=td1 "+myShowTips(sMethod)+" ><p>根据企业的财务结构、财务指标，总体评价申请人的财务状况：</p>");
  	sTemp.append("     <p>1、企业规模的分析；</p>");
  	sTemp.append("     <p>2、盈利能力和营运能力分析；</p>");
  	sTemp.append("     <p>3、流动性分析；</p>");
  	sTemp.append("     <p>4、资本结构分析和长期偿债能力分析；</p>");
  	sTemp.append("     <p>5、现金流分析；</p>");
  	sTemp.append("     <p>6、发展趋势分析；</p>");
  	sTemp.append("     <p>7、资产质量分析；</p>");
  	sTemp.append("     8、企业信用等级评定是否合理，不合理的原因；");
  	sTemp.append("   </td>");
    sTemp.append("   </tr>");
    sTemp.append("   <tr>");
