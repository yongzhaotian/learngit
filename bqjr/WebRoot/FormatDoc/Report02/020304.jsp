...
<%
	...
	sTemp.append("   <td class=td1 align=left colspan='7' bgcolor=#aaaaaa ><font style=' font-size: 12pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >2.3.4、在他行未结清授信业务信息（单位：万元） </font></td>"); 	
	sTemp.append("   </tr>");	
	sTemp.append("   <tr>");
	...
	sTemp.append("   <tr>");
  	sTemp.append("   <td colspan='7' align=left class=td1 "+myShowTips(sMethod)+" >分析总结在他行未结清授信情况，重点分析财务报表中短期债务和长期债务与人民银行贷款记录中不符情况。");
	sTemp.append("   </td>");
    sTemp.append("   </tr>");
    sTemp.append("   <tr>");
