...
<%
	...
	sTemp.append("   </tr>");
	String sSql = "select CustomerName,InvestDate ,Describe,InvestmentSum,InvestmentProp "
    ...
    sTemp.append("   <td width=17% align=center class=td1 > 比例％ </td>");
	sTemp.append("   </tr>");
	sSql = "select CustomerName,InvestDate ,Describe,InvestmentSum,InvestmentProp "
		  +"from CUSTOMER_RELATIVE "
		  +"where CustomerID='"+sCustomerID+"' "
