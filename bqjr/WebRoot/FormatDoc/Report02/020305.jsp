...
<%
	...
	sTemp.append("   <td class=td1 align=left colspan='5' bgcolor=#aaaaaa ><font style=' font-size: 12pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >2.3.5、在他行的担保信息（单位：万元）</font></td>"); 	
	sTemp.append("   </tr>");	
	sTemp.append("   <tr>");
	...
	/*
	sTemp.append("   <tr>");
  	sTemp.append("   <td colspan=2 align=left class=td1 > 小计：  </td>");
    sTemp.append("   <td width=15% align=right class=td1 >"+DataConvert.toMoney(dBusinessSum)+"&nbsp;</td>");
