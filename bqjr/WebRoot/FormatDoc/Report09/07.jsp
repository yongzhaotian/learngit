...
<%
	...
	sTemp.append("   <tr>");	
	sTemp.append("   <td class=td1 align=left bgcolor=#aaaaaa ><font style=' font-size: 12pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >7、授信风险分析及相应的风险防范措施</font></td>"); 	
	sTemp.append("   </tr>");
    sTemp.append("   <tr>");
