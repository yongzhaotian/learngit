...
<%
	...
	sTemp.append("<form method='post' action='020203.jsp' name='reportInfo'>");	
	sTemp.append("<div id=reporttable>");	
	sTemp.append("<table class=table1 width='640' align=center border=1 cellspacing=0 cellpadding=2 bgcolor=white bordercolor=black bordercolordark=black >	");
	sTemp.append("   <tr>");	
	//colspan需根据实际情况调整，否则导出时会比较不雅
	sTemp.append("   <td class=td1 align=left colspan='7' bgcolor=#aaaaaa ><font style=' font-size: 12pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >2.2.3、在他行未结清授信业务信息 </font></td>"); 	
	sTemp.append("   </tr>");	
	sTemp.append("   <tr>");
	...
	while(rs2.next())
	{
		...
		if(sBusinessType.equals("020"))
		{
		    ...
		    sTemp.append("   <td width=16% align=center class=td1 >"+sBalance+"&nbsp; </td>");
		...
		sSql = " select getItemName('Currency',BusinessCurrency) as CurrencyName,sum(BusinessSum)"+
           ...
           " where CustomerID = '"+sCustomerID+"' group by BusinessCurrency";
		rs3 = Sqlca.getResultSet(sSql);
		String sSum = "";
		while(rs3.next())
		{
			sSum += rs3.getString(1)+"&nbsp;&nbsp;&nbsp;"+DataConvert.toMoney(rs3.getString(2))+"<br>"; 
		}	
