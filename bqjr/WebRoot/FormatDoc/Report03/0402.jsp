...
<%
	...
	String sRowName[] = {"利息保障倍数","流动比率","速动比率","资产负债比率"};
	String sCol2Value[]={"","","",""};
	String sCol2Value1[]={"","","",""};
	String sCol2Value2[]={"","","",""};
...
<%
	...
	sTemp.append("   <td class=td1 align=left colspan='4' bgcolor=#aaaaaa ><font style=' font-size: 12pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >4.2、偿债能力分析</font></td>"); 	
	sTemp.append("   </tr>");	
	sTemp.append("   <tr>");
