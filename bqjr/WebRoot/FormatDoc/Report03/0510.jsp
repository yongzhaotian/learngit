...
<%
	...
	sTemp.append("   <td class=td1 align=left colspan='4' bgcolor=#aaaaaa ><font style=' font-size: 12pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >"+sNo1[j]+"、履约保险保证</font></td>"); 	
	sTemp.append("   </tr>");	
	sTemp.append("   <tr>");
