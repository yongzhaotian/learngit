...
<%
	...
	sTemp.append(" <tr>");	
	sTemp.append(" <td class=td1 align=left colspan=10 bgcolor=#aaaaaa ><font style=' font-size: 12pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >2.1、在我行的授信业务信息</font></td>"); 	
	sTemp.append(" </tr>");
	sTemp.append(" <tr>");
	...
	{	
		...
		dBailRatio = rs2.getDouble(4);
		dBusinessRate = rs2.getDouble(5);
    ...
    sTemp.append(" <td width=22% align=center class=td1 >"+dBailRatio+"&nbsp;</td>");
    sTemp.append(" <td width=16% align=center class=td1 >"+dBusinessRate+"&nbsp;</td>");
    ...
    sTemp.append(" <td colspan=2 align=center class=td1 >"+dBusinessSum+"&nbsp;</td>");
