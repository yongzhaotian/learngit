...
<%
	...
	double dBusinessSum = 0.0;			//金额	
	double dBailRatio = 0.0;			//保证金比例％
	double dBusinessRate = 0.0;			//利率
	double dPdgRatio = 0.0;				//手续费率
...
<%
	...
	sTemp.append("   <td class=td1 align=left colspan='6' bgcolor=#aaaaaa ><font style=' font-size: 12pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >1、业务概况</font></td> ");	
	sTemp.append("   </tr>");	
	sTemp.append("   <tr>");
    ...
    sTemp.append(" <td width=18% align=center class=td1 > 金额 </td>");
    ...
    sTemp.append(" </tr>");
	sTemp.append("  <tr>");
  	sTemp.append(" <td colspan='6' align=left class=td1 > 本笔授信业务的资金用途：<br>"+sPurpose+"</td>");
    sTemp.append(" </tr>");
	sTemp.append("</table>");	
	sTemp.append("</div>");	
