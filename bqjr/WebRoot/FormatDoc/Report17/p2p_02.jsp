...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Main00;Describe=注释区;]~*/%>
	...
	/*
		...
		History Log: 
			2015-4-9  dahl  p2p批复函，根据消费贷的模版，把sRepaymentBank改为：招商银行股份有限公司深圳安联支行
	 */
	%>
<%/*~END~*/%>
...
<%
	...
	if(rs2.next()){
		...
		sRepaymentBank = "招商银行股份有限公司深圳安联支行";
	...
	//sEndTime = Sqlca.getString("");
		...
		if("2015061500000017".equals(btype2)){
			...
			sTemp.append("   <td colspan=2 align=left class=td1 >24.销售顾问签名：</td>");
			sTemp.append("   </tr>");
			sTemp.append("   <tr>");
