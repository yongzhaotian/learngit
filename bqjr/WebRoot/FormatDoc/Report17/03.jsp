...
/* 	sTemp.append("<tr>");
	...
	sTemp.append("<td colspan=1 align=left class=td1 >52.是否申请参加保险："+("是".equals(sCreditCycleName)?"是■&nbsp;&nbsp;否□</td>":"是□&nbsp;&nbsp;否■</td>"));
	...
	sTemp.append("<td colspan=6 align=left class=td1 >55.开户银行：<br>&nbsp;&nbsp;&nbsp;&nbsp;招商银行深圳四海支行 &nbsp;</td>");
