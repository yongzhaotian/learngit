...
ASResultSet rs2 = Sqlca.getResultSet(sSql);
	...
	if ("2".equals(sCreditCycle)) sCreditCycleName = "否";
	else if ("1".equals(sCreditCycle)) sCreditCycleName = "是";
%>
...
/* 	sTemp.append("<tr>");
	...
	sTemp.append("<td colspan=2 align=left class=td1 >52.是否投保："+sCreditCycleName+"&nbsp;</td>");
	sTemp.append("</tr>");
	...
	sTemp.append("</tr>");
	sTemp.append("<tr>");
	sTemp.append("<td colspan=2 align=left class=td1 >53.指定还款账户账号：<br>&nbsp;&nbsp;&nbsp;&nbsp;"+sRepaymentNo+"&nbsp;<br></td>");
	sTemp.append("<td colspan=4 align=left class=td1 >54.开户银行：<br>&nbsp;&nbsp;&nbsp;&nbsp;招商银行深圳四海支行 &nbsp;</td>");
	sTemp.append("<td colspan=4 align=left class=td1 >55.户名："+sRepaymentName+"&nbsp;</td>");
	...
	sTemp.append("<td colspan=3 align=left class=td1 >58.客户银行账户名：<br>&nbsp;&nbsp;&nbsp;&nbsp;"+sReplaceName+"&nbsp;</td>");
	sTemp.append("<td colspan=1 align=left class=td1 >59.银行代扣还款："+repaymentWay+"&nbsp;</td>");
	sTemp.append("</tr>");
	sTemp.append("<tr>");
	...
	sTemp.append("<tr>");
	sTemp.append("<td colspan=2 align=left class=td1 >60.单位/学校/个体全称："+sWorkCorp+"&nbsp;</td>");
	sTemp.append("<td colspan=2 align=left class=td1 >61.任职部门/班级："+sEmployRecord+"&nbsp;</td>");
	...
	sTemp.append("<tr>");
	sTemp.append("<td colspan=2 align=left class=td1 >66.单位地址："+sWorkAdd+"&nbsp;</td>");
	...
	sTemp.append("<td colspan=2 align=left class=td1 >72.总工作经验/大学学习时间(年)："+sJobTotal+"</td>");
	sTemp.append("<td colspan=4 align=left class=td1 >73.现单位工作/个体营业时间/距离毕业时间(月)："+sJobTime+"</td>");
	...
	sTemp.append("<td colspan=4 align=left class=td1 >76.配偶移动电话："+sSpouseTel+"</td>");
	sTemp.append("<td colspan=2 align=left class=td1 >77.配偶单位名称：</td>");
	sTemp.append("<td colspan=2 align=left class=td1 >78.配偶单位电话：</td>");
	sTemp.append("</tr>");
	sTemp.append("<tr>");
	...
	sTemp.append("<td colspan=2 align=left class=td1 >81.家庭成员电话："+sKinshipTel+"</td>");
	sTemp.append("<td colspan=2 align=left class=td1 >82.家庭成员联系地址："+sKinshipAdd+"</td>");
	sTemp.append("</tr>");
	...
	sTemp.append("</tr>");
	sTemp.append("<tr style='height:20px;'>");
	sTemp.append("<td colspan=2 align=left class=td1 >83.联系人姓名："+sOtherContact+"</td>");
	sTemp.append("<td colspan=4 align=left class=td1 >84.与申请人关系："+sRelativeType1+"</td>");
	sTemp.append("<td colspan=4 align=left class=td1 >85.联系电话："+sContactTel+"</td>");
	sTemp.append("</tr>");
	sTemp.append("<tr>");
	sTemp.append("<td colspan=10 align=center class=td1 bgcolor=#aaaaaa ><b>收入及支出信息</b>&nbsp;</td>");
	sTemp.append("</tr>");
	sTemp.append("<tr>");
	sTemp.append("<td colspan=2 align=left class=td1 >86.月收入总额（元）："+sZE+"</td>");
	sTemp.append("<td colspan=4 align=left class=td1 >87.其他收入（元/月）："+sOtherRevenue+"</td>");
	sTemp.append("<td colspan=2 align=left class=td1 >88.家庭月收入（元）：<br>&nbsp;&nbsp;"+sFamilyMonthIncome+"</td>");
	sTemp.append("<td colspan=2 align=left class=td1 >89.个人支出（元/月）："+sCE+"</td>");
	sTemp.append("</tr>");
