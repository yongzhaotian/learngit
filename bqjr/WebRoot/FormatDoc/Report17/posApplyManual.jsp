...
/* 	sTemp.append("<tr>");
	...
	sTemp.append("<td colspan=2 align=left class=td1 >51.每月随心还服务费(元): "+bugPayPkgindFee+"&nbsp;&nbsp;&nbsp;是否选择随心还："+sBugPayPkgind+"&nbsp;</td>");
	...
	sTemp.append("<td colspan=1 align=left class=td1 >60.是否选择银行代扣还款："+("1".equals(repaymentWay)?"是■&nbsp;&nbsp;否□":"是□&nbsp;&nbsp;否■")+"</td>");
	sTemp.append("</tr>");
	sTemp.append("<tr>");
