...
/* 	sTemp.append("<tr>");
	...
	*/
	...
	sTemp.append("<td colspan=4 align=left class=td1 >95.其他收入（元/月）："+sOtherRevenue+"</td>");
	sTemp.append("<td colspan=3 align=left class=td1 >96.每月收入来源 :"+monthly_income_source+"</td>");
