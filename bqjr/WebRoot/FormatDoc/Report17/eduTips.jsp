...
ASResultSet rs = Sqlca.getASResultSet(sSql);
	...
	if(!sPutOutDate.equals("&nbsp;")){	
		...
		// sFirstDueDate = df.format(df.parse(sFirstDueDate)); 
		 year =sFirstDueDate.substring(0,4);
		 month = sFirstDueDate.substring(5,7);
		 day = sFirstDueDate.substring(8,10);
	}
...
<%
	...
	sTemp.append("<tr><td style='border:0px;text-align:left; font-size: 12pt;FONT-FAMILY:黑体;FONT-WEIGHT: bold;color:black;>&nbsp;</td></tr>");
	sTemp.append("<tr><td style='border:0px;text-align:left; font-size: 12pt;FONT-FAMILY:仿宋_GB2312;FONT-WEIGHT: bold;color:black; colspan=6 style='text-decoration: underline;'><u>您贷款的信息如下：</u></td></tr>");
	sTemp.append("<tr><td style='border:0px;text-align:left; font-size: 12pt;FONT-FAMILY:黑体;FONT-WEIGHT: bold;color:black;>&nbsp;</td></tr>");
	...
	sTemp.append("<tr><td style='border:0px;text-align:left; font-size: 12pt;FONT-FAMILY:仿宋_GB2312;FONT-WEIGHT: bold;color:black; colspan=6>首次还款日："+year+"年"+month+"月"+day+"号&nbsp;&nbsp;&nbsp;首次还款额：&yen;"+sFirstPayAmt+"</td></tr>");
	sTemp.append("<tr><td style='border:0px;text-align:left; font-size: 12pt;FONT-FAMILY:黑体;FONT-WEIGHT: bold;color:black;>&nbsp;</td></tr>");
	...
	sTemp.append("<tr><td style='border:0px;text-align:left; font-size: 12pt;FONT-FAMILY:仿宋_GB2312;FONT-WEIGHT: bold;color:black; colspan=6>月财务管理费（元）:"+sManageFee+"&nbsp;</td></tr>");
	sTemp.append("<tr><td style='border:0px;text-align:left; font-size: 12pt;FONT-FAMILY:黑体;FONT-WEIGHT: bold;color:black;>&nbsp;</td></tr>");
	
	sTemp.append("<tr><td style='border:0px;text-align:left; font-size: 12pt;FONT-FAMILY:仿宋_GB2312;FONT-WEIGHT: bold;color:black; colspan=6>月随心还服务费金额（元）:"+bugPayPkgindFee+"&nbsp;</td></tr>");
	sTemp.append("<tr><td style='border:0px;text-align:left; font-size: 12pt;FONT-FAMILY:黑体;FONT-WEIGHT: bold;color:black;>&nbsp;</td></tr>");
	...
	String sq = "select count(serialno) as contractnum from business_contract where CustomerID=(select customerid from Business_contract where serialno = '"+sObjectNo+"') and serialno <> '"+sObjectNo+"'";
	 /* ASResultSet re = Sqlca.getASResultSet(sq);
	  while(re.next()){
		...
		sTemp.append("<tr><td style='border:0px;text-align:left; font-size: 11pt;FONT-FAMILY:仿宋_GB2312;FONT-WEIGHT: bold;color:black; colspan=6 '>本人已阅读并接受上述文字内容。（本文件一式两份，客户及我司各留存一份）</td></tr>");
		sTemp.append("<tr><td style='border:0px;text-align:left; font-size: 11pt;FONT-FAMILY:黑体;FONT-WEIGHT: bold;color:black; colspan=6 '>&nbsp;</td></tr>");

		sTemp.append("<tr><td style='border:0px;text-align:right; font-size: 11pt;FONT-FAMILY:黑体;FONT-WEIGHT: bold;color:black; colspan=6 '>客户签名:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;日期:"+SystemConfig.getBusinessDate()+"&nbsp;&nbsp;&nbsp;&nbsp;</td></tr>");	
