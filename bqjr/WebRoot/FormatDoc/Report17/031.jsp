...
String sOpenBranch="",sInputDate="",sBusinessType1="",sBrandType1="",sPrice1="",sBusinessType2="",sBrandType2="",sPrice2="",sFlag8="",sManufacturer1="",sManufacturer2="";//客户开户行
...
String sDfile = "本人选择银行代扣还款，表明本人同意并授权贷款人可通过银行从本人指定的银行账户（如第53项所示）将每月还款额（如第43项所示）及其它应还款项转入指定还款账户（如第50项所示）。本人同意此扣款授权同时适用于之前已签订的一份或多份个人消费类贷款合同，即贷款人可通过银行从本人指定的上述银行账户内扣划本人在各合同下应偿还的相关款项。本人同意该账户同时可用于因提前还款等引起的资金往来。";
...
/* 	sTemp.append("<tr>");
	...
	sTemp.append("<td class=td1 rowspan=2 align=center colspan=7 bgcolor=#aaaaaa ><font style=' font-size: 12pt;FONT-FAMILY:宋体;FONT-WEIGHT: bold;color:black;background-color:#aaaaaa' >现金分期服务申请表</font></td> ");	
	...
	sTemp.append("</tr>");
	sTemp.append("<tr>");
	sTemp.append("<td colspan=1 align=left class=td1 >销售点地址："+sAddress+"&nbsp;</td>");
	...
	sTemp.append("<td colspan=3 align=left class=td1 >6.社保号码/学生号码："+sSino+"&nbsp;</td>");
	...
	sTemp.append("<tr>");
	sTemp.append("<td colspan=1 align=left class=td1 >9.住宅电话登记人："+sPhoneMan+"&nbsp;</td>");
	sTemp.append("<td colspan=3 align=left class=td1 >10.手机："+sMobileTelephone+"&nbsp;</td>");
	...
	sTemp.append("<td colspan=3 align=left class=td1 >28.品牌(1)："+sManufacturer1+"&nbsp;</td>");
	sTemp.append("<td colspan=3 align=left class=td1 >29.商品型号(1)："+sBrandType1+"&nbsp;</td>");
	...
	sTemp.append("<td colspan=3 align=left class=td1 >32.品牌(2)："+sManufacturer2+"&nbsp;</td>");
	sTemp.append("<td colspan=3 align=left class=td1 >33.商品型号(2)："+sBrandType2+"&nbsp;</td>");
	sTemp.append("<td colspan=2 align=left class=td1 >34.价格(2)(元)："+sPrice2+"&nbsp;</td>");
	sTemp.append("</tr>");
	
	sTemp.append("<tr>");
	sTemp.append("<td colspan=2 align=left class=td1 >35.商品总价（元）："+sTotalPrice+"&nbsp;</td>");
	sTemp.append("<td colspan=3 align=left class=td1 >36.自付金额（元）："+sTotalSum+"&nbsp;</td>");
	sTemp.append("<td colspan=3 align=left class=td1 >37.贷款本金（元）："+sBusinessSum+"&nbsp;</td>");
	sTemp.append("<td colspan=2 align=left class=td1 >38.分期期数："+sPeriods+"&nbsp;</td>");
	sTemp.append("</tr>");
	
	sTemp.append("<tr>");
	sTemp.append("<td colspan=2 align=left class=td1 >39.每月还款额（元）："+sMonthRepayMent+"&nbsp;</td>");
	sTemp.append("<td colspan=3 align=left class=td1 >40.首次还款日："+sFirstDueDate+"&nbsp;</td>");
	sTemp.append("<td colspan=3 align=left class=td1 >41.每月还款日："+sDefaultDueDay+"&nbsp;</td>");
	sTemp.append("<td colspan=2 align=left class=td1 >42.月贷款利率（%）："+sCreditRate+"&nbsp;</td>");
	sTemp.append("</tr>");
	
	sTemp.append("<tr>");
	sTemp.append("<td colspan=2 align=left class=td1 >43.月客户服务费率（%）："+sCUSTOMERSERVICERATES+"&nbsp;</td>");
	sTemp.append("<td colspan=3 align=left class=td1 >44.月财务管理费率（%）："+sMANAGEMENTFEESRATE+"&nbsp;</td>");
	sTemp.append("<td colspan=3 align=left class=td1 >&nbsp;</td>");
	sTemp.append("<td colspan=2 align=left class=td1 >45.印花税（%）："+sSTAMPTAX+"&nbsp;</td>");
	sTemp.append("</tr>");
	...
	sTemp.append("</tr>");
	sTemp.append("<tr>");
	sTemp.append("<td colspan=3 align=left class=td1 >46.指定还款账户账号："+sRepaymentNo+"&nbsp;<br></td>");
	sTemp.append("<td colspan=3 align=left class=td1 >47.开户银行：招商银行深圳四海支行 &nbsp;</td>");
	sTemp.append("<td colspan=4 align=left class=td1 >48.户名："+sRepaymentName+"&nbsp;</td>");
	sTemp.append("</tr>");
	
	
	sTemp.append("<tr>");
	sTemp.append("<td colspan=3 align=left class=td1 >49.客户银行卡号/账号："+sReplaceAccount+"&nbsp;</td>");
	sTemp.append("<td colspan=2 align=left class=td1 >50.客户开户银行："+sOpenBranch+"&nbsp;</td>");
	sTemp.append("<td colspan=3 align=left class=td1 >51.客户银行账户名："+sReplaceName+"&nbsp;</td>");
	sTemp.append("<td colspan=2 align=left class=td1 >52.银行代扣还款："+repaymentWay+"&nbsp;</td>");
	sTemp.append("</tr>");
	sTemp.append("<tr>");
	...
	sTemp.append("<tr>");
	sTemp.append("<td colspan=2 align=left class=td1 >53.单位/学校/个体全称："+sWorkCorp+"&nbsp;</td>");
	sTemp.append("<td colspan=2 align=left class=td1 >54.任职部门/班级："+sEmployRecord+"&nbsp;</td>");
	sTemp.append("<td colspan=2 align=left class=td1 >55.职位："+sHeadShip+"&nbsp;</td>");
	sTemp.append("<td colspan=2 align=left class=td1 >56.行业类别："+sIndustryType+"&nbsp;</td>");
	sTemp.append("<td colspan=1 align=left class=td1 >57.单位性质："+sCellProperty+"&nbsp;</td>");
	sTemp.append("<td colspan=1 align=left class=td1 >58.单位电话："+sWorkTel+"&nbsp;</td>");
	sTemp.append("</tr>");
	
	sTemp.append("<tr>");
	sTemp.append("<td colspan=2 align=left class=td1 >59.单位地址："+sWorkAdd+"&nbsp;</td>");
	sTemp.append("<td colspan=2 align=left class=td1 >60.镇/乡："+sUnitCountryside+"&nbsp;</td>");
	sTemp.append("<td colspan=2 align=left class=td1 >61.街道/村："+sUnitStreet+"&nbsp;</td>");
	sTemp.append("<td colspan=2 align=left class=td1 >62.小区/楼盘："+sUnitRoom+"&nbsp;</td>");
	sTemp.append("<td colspan=2 align=left class=td1 >63.栋/单元/房间号："+sUnitNo+"</td>");
	sTemp.append("</tr>");
	
	sTemp.append("<tr>");
	sTemp.append("<td colspan=2 align=left class=td1 >64.邮寄地址："+sFlag8+"</td>");
	sTemp.append("<td colspan=2 align=left class=td1 >65.总工作经验/大学学习时间(年)："+sJobTotal+"</td>");
	sTemp.append("<td colspan=3 align=left class=td1 >66.现单位工作/个体营业时间/距离毕业时间(月)："+sJobTime+"</td>");
	sTemp.append("<td colspan=3 align=left class=td1 >67.在现单位是否购买社保："+sFlag4+"</td>");
	sTemp.append("</tr>");
	...
	sTemp.append("<tr>");
	sTemp.append("<td colspan=3 align=left class=td1 >68.配偶姓名："+sSpouseName+"</td>");
	sTemp.append("<td colspan=3 align=left class=td1 >69.配偶移动电话："+sSpouseTel+"</td>");
	sTemp.append("<td colspan=2 align=left class=td1 >70.配偶单位名称：</td>");
	sTemp.append("<td colspan=2 align=left class=td1 >71.配偶单位电话：</td>");
	sTemp.append("</tr>");
	sTemp.append("<tr>");
	sTemp.append("<td colspan=3 align=left class=td1 >72.家庭成员名称："+sKinshipName+"</td>");
	sTemp.append("<td colspan=3 align=left class=td1 >73.家庭成员类型："+sRelativeType+"</td>");
	sTemp.append("<td colspan=2 align=left class=td1 >74.家庭成员电话："+sKinshipTel+"</td>");
	sTemp.append("<td colspan=2 align=left class=td1 >75.家庭成员联系地址："+sKinshipAdd+"</td>");
	sTemp.append("</tr>");
	...
	sTemp.append("</tr>");
	sTemp.append("<tr>");
	sTemp.append("<td colspan=3 align=left class=td1 >76.联系人姓名："+sOtherContact+"</td>");
	sTemp.append("<td colspan=3 align=left class=td1 >77.与申请人关系："+sRelativeType1+"</td>");
	sTemp.append("<td colspan=4 align=left class=td1 >78.联系电话："+sContactTel+"</td>");
	sTemp.append("</tr>");
	sTemp.append("<tr>");
	sTemp.append("<td colspan=10 align=center class=td1 bgcolor=#aaaaaa ><b>收入及支出信息</b>&nbsp;</td>");
	sTemp.append("</tr>");
	sTemp.append("<tr>");
	sTemp.append("<td colspan=3 align=left class=td1 >79.月收入总额（元）："+sZE+"</td>");
	sTemp.append("<td colspan=3 align=left class=td1 >80.其他收入（元/月）："+sOtherRevenue+"</td>");
	sTemp.append("<td colspan=2 align=left class=td1 >81.家庭月收入（元）："+sFamilyMonthIncome+"</td>");
	sTemp.append("<td colspan=2 align=left class=td1 >82.个人支出（元/月）："+sCE+"</td>");
	sTemp.append("</tr>");
	...
	sTemp.append("<td colspan=3 align=left class=td1 >是否签署授权书:"+sfalg6+"&nbsp;</td>");
	sTemp.append("</tr>");
	
	sTemp.append("<tr>");
	sTemp.append("<td colspan=10 align=left class=td1 ><font style=' font-size: 8pt;' >本人具有完全民事行为能力签署本申请表并承担相应责任。本人已仔细阅读并完全了解《分期购消费贷款三方协议》，并且自愿遵守相关的合同规定。<br>本人保证在此表上填写、确认的内容及向贷款人、佰仟金融提供的所有相关资料全部真实、有效，如本人提供虚假资料，将承担由此引起的一切责任及损失。本人在此同意贷款人和佰仟金融按照相关法律法规的规定，向有权机构报送本人的个人信用信息，包括但不限于本申请表项下的信息，同时，授权贷款人和佰仟金融向任何可能的来源查询本人及配偶的与贷款申请有关的个人信息和个人信用信息，相关查询结果的用途将用于贷款审查和贷款管理。<br>本人同意如因单方面取消申请或不具备借款条件，申请不获批准，本表格及所有已提交的资料无须退还本人，由佰仟金融处理。贷款人有权拒绝本贷款申请而无须给予任何原因解释。</td>");
	sTemp.append("</tr>");
	sTemp.append("<tr>");
	...
	sTemp.append("<div>");
	sTemp.append("<tr>");
	sTemp.append("<td colspan=10 class=td1 ><font style=' font-size: 8pt;' >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;现金分期消费贷款三方协议<br>"
		...
		+"	十、其他约定1．如本合同任何条款之一被司法机关或者其他有权部门认定为无效，该条款将不影响其余条款的有效性。2. 借款人授权佰仟金融保存借款人的本合同原件并同意佰仟金融在借款人付清本合同项下的全部款项之后销毁该原件。3．佰仟金融可不时地向借款人提供关于本合同履行的优惠条款。与本合同的约定相比，该优惠条款将对借款人更有利，经借款人确认后，该优惠条款即生效。4. 借款人确认已经认真阅读并完全理解本协议中的各项条款，且对协议中免除和限制借款人责任的条款已收到贷款人和佰仟金融的提醒注意和特别说明。<br>"
		+"贷款人：中泰信托有限责任公司&nbsp;&nbsp;&nbsp;&nbsp;借款人：&nbsp;&nbsp;&nbsp;佰仟金融：深圳市佰仟金融服务有限公司<br>合同签署日：&nbsp;&nbsp;&nbsp;&nbsp;合同签订地：广东省深圳市前海深港合作区</td>");
	sTemp.append("</tr>");
