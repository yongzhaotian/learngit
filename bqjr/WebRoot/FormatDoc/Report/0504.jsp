...
<%
	...
	sTemp.append(myOutPut("0",sMethod,"name='describe5' style='width:100%; height:150'",getUnitData("describe5",sData)));
	sTemp.append("	 &nbsp;</td>");
    sTemp.append("   <td colspan='3' align=center class=td1 >");
    sTemp.append(myOutPut("0",sMethod,"name='describe6' style='width:100%; height:150'",getUnitData("describe6",sData)));
    sTemp.append("	 &nbsp;</td>");
    sTemp.append("   <td colspan='3' align=center class=td1 >");
    sTemp.append(myOutPut("0",sMethod,"name='describe7' style='width:100%; height:150'",getUnitData("describe7",sData)));
    sTemp.append("	 &nbsp;</td>");
	sTemp.append("  </tr>");
	sTemp.append("  <tr>");
	sTemp.append("   <td colspan='6' align=center class=td1 >");
	sTemp.append(myOutPut("0",sMethod,"name='describe8' style='width:100%; height:150'",getUnitData("describe8",sData)));
	sTemp.append("	 &nbsp;</td>");
    sTemp.append("   <td colspan='3' align=center class=td1 >");
    sTemp.append(myOutPut("0",sMethod,"name='describe9' style='width:100%; height:150'",getUnitData("describe9",sData)));
    sTemp.append("	 &nbsp;</td>");
    sTemp.append("   <td colspan='3' align=center class=td1 >");
    sTemp.append(myOutPut("0",sMethod,"name='describe10' style='width:100%; height:150'",getUnitData("describe10",sData)));
    sTemp.append("	 &nbsp;</td>");
	sTemp.append("  </tr>");
	sTemp.append("  <tr>");
	sTemp.append("   <td colspan='6' align=center class=td1 > 合计 </td>");
    sTemp.append("   <td colspan='3' align=center class=td1 >");
    sTemp.append(myOutPut("0",sMethod,"name='describe11' style='width:100%; height:150'",getUnitData("describe11",sData)));
    sTemp.append("	 &nbsp;</td>");
    sTemp.append("   <td colspan='3' align=center class=td1 >&nbsp;</td>");
	sTemp.append("  </tr>");
	sTemp.append("  <tr>");
    ...
    sTemp.append("   <td colspan='3' align=center class=td1 >");
    sTemp.append(myOutPut("0",sMethod,"name='describe12' style='width:100%; height:150'",getUnitData("describe12",sData)));
    sTemp.append("	 &nbsp;</td>");
    sTemp.append("   <td colspan='3' align=center class=td1 >&nbsp;</td>");
	sTemp.append("  </tr>");
	sTemp.append("  <tr>");
