...
<%
	...
	//sEndTime = Sqlca.getString("");
		...
		sTemp.append("   <tr>");
		sTemp.append("<td colspan=1 rowspan=2 style='margin-left:30%' align=left><img src='"+sWebRootPath+"/FormatDoc/Images/JC01.png' /></td>");
		sTemp.append("   </tr>");
		sTemp.append("</table>");
	...
	sTemp.append("<font style=' font-size: 9pt;' >版本号：J_XF_TY_TY_2016030801  商家联</font></br>");
	sTemp.append("----------------------------------------------------------------------------------");
	sTemp.append("</div>");	
	...
	sTemp.append("<div id=reporttable >");
		...
		sTemp.append("</table>");
	sTemp.append("</div>");	
	sTemp.append("<div align=letf>");	
	sTemp.append("<font style=' font-size: 9pt;' >版本号：J_XF_TY_TY_2016030801   公司联</font></br>");
	sTemp.append("</div>");	
