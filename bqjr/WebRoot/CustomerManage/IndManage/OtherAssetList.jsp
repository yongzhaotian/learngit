<%@ page contentType="text/html; charset=GBK"%><%@
 include file="/IncludeBegin.jsp"%><%
	/*
		页面说明: 示例列表页面
	 */
	String PG_TITLE = "其他资产情况列表";
	//获得页面参数
	String sCustomerID =  DataConvert.toRealString(iPostChange,(String)CurPage.getParameter("CustomerID"));
	if(sCustomerID==null) sCustomerID="";
	
	//通过DW模型产生ASDataObject对象doTemp
	String sTempletNo = "OtherAssetList";//模型编号
	...
	String sButtons[][] = {
		{"true","","Button","新增","新增其他资产情况","newRecord()",sResourcesPath},
		{"true","","Button","详情","查看其他资产情况","viewAndEdit()",sResourcesPath},
		{"true","","Button","删除","删除其他资产情况","deleteRecord()",sResourcesPath},
		};
	%>
<%/*~END~*/%>
