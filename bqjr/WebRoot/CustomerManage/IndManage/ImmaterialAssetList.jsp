...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List01;Describe=定义页面属性;]~*/%>
	<%
	String PG_TITLE = "无形资产情况"; // 浏览器窗口标题 <title> PG_TITLE </title>
	%>
<%/*~END~*/%>
...
<%
	...
	String sTempletNo = "ImmaterialAssetList";//模型编号
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List04;Describe=定义按钮;]~*/%>
	...
	String sButtons[][] = {
		{"true","","Button","新增","新增无形资产情况","newRecord()",sResourcesPath},
		{"true","","Button","详情","查看无形资产情况","viewAndEdit()",sResourcesPath},
		{"true","","Button","删除","删除无形资产情况","deleteRecord()",sResourcesPath},
		};
	%>
<%/*~END~*/%>
