...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List01;Describe=定义页面属性;]~*/%>
	<%
	String PG_TITLE = "配偶及家庭主要成员列表"; // 浏览器窗口标题 <title> PG_TITLE </title>
	%>
<%/*~END~*/%>
...
<%
	...
	String sTempletNo = "IndFamilyList";//模型编号
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List04;Describe=定义按钮;]~*/%>
	...
	String sButtons[][] = {
		{"true","","Button","新增","新增配偶及家庭主要成员","newRecord()",sResourcesPath},
		{"true","","Button","详情","查看配偶及家庭主要成员详情","viewAndEdit()",sResourcesPath},
		{"true","","Button","删除","删除配偶及家庭主要成员","deleteRecord()",sResourcesPath},
		};
	%> 
<%/*~END~*/%>
