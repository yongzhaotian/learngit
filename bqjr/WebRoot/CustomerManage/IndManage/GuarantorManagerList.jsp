...
<%
	...
	String sTempletNo = "GuarantorManagerList"; //模版编号
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	function newRecord()
	{
		...
		sCompURL = "/CreditManage/CreditApply/CarGuarantorApplyInfo.jsp";
		...
		if(sObjectNo !=""){
			OpenPage("/CustomerManage/IndManage/GuarantorManagerInfo.jsp?CustomerID="+sCustomerID+"&CustomerType="+sCustomerType,"_self","");
		}
	}
