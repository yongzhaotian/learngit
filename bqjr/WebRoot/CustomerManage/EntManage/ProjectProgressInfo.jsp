...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Info03;Describe=定义数据对象;]~*/%>
	...
	String sTempletNo = "ProjectProgressInfo";
	String sTempletFilter=" (ColAttribute is null or ColAttribute like '%"+sProjectType+"%')";
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=Info06;Describe=定义按钮事件;]~*/%>
	...
	function goBack()
	{
		OpenPage("/CustomerManage/EntManage/ProjectProgressList.jsp","_self","");
	}
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=Info07;Describe=自定义函数;]~*/%>
	...
	{
		var sTableName = "PROJECT_PROGRESS";//表名
