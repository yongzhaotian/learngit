...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List01;Describe=定义页面属性;]~*/%>
	<%
	String PG_TITLE = "上下游企业关联列表"; // 浏览器窗口标题 <title> PG_TITLE </title>
	%>
<%/*~END~*/%>
...
<%	
	...
	String sTempletNo = "EntOtherRelativeList"; //模版编号
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List04;Describe=定义按钮;]~*/%>
	...
	String sButtons[][] = {
		{"true","All","Button","新增","新增上下游企业关联信息","newRecord()",sResourcesPath},
		{"true","","Button","详情","查看上下游企业关联详情","viewAndEdit()",sResourcesPath},
		{"true","All","Button","删除","删除上下游企业关联信息","deleteRecord()",sResourcesPath},
		};
	%> 
<%/*~END~*/%>
