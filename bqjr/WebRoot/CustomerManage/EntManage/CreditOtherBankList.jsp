<%@ page contentType="text/html; charset=GBK"%><%@
 include file="/IncludeBegin.jsp"%><%
	...
	String sButtons[][] = {
		{"true","All","Button","新增","新增在其他金融机构业务活动情况","newRecord()",sResourcesPath},
		{"true","","Button","详情","查看在其他金融机构业务活动情况","viewAndEdit()",sResourcesPath},
		{"true","All","Button","删除","删除在其他金融机构业务活动情况","deleteRecord()",sResourcesPath},
		};
	%>
<%/*~END~*/%>
