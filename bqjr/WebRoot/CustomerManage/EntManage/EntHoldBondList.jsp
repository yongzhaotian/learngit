<%@ page contentType="text/html; charset=GBK"%><%@
 include file="/IncludeBegin.jsp"%><%
	/*
		页面说明: 示例列表页面
	 */
	String PG_TITLE = "客户持有债券信息列表";
	//获得页面参数
	String sCustomerID =  DataConvert.toRealString(iPostChange,(String)CurPage.getParameter("CustomerID"));
	if(sCustomerID==null) sCustomerID="";
	
	//通过DW模型产生ASDataObject对象doTemp
	String sTempletNo = "EntHoldBondList";//模型编号
	...
	String sButtons[][] = {
		{"true","All","Button","新增","新增客户持有债券信息","newRecord()",sResourcesPath},
		{"true","","Button","详情","查看客户持有债券详细信息","viewAndEdit()",sResourcesPath},
		{"true","All","Button","删除","删除客户持有债券信息","deleteRecord()",sResourcesPath},
		};
	%>
<%/*~END~*/%>
