...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List00;Describe=注释区;]~*/%>
	...
	/*
		...
		HistoryLog:zywei 2006/1/4 重检代码
		           cbsu 2009/10/27 将"组织机构代码"设为不可见
	 */
	%>
<%/*~END~*/%>
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List01;Describe=定义页面属性;]~*/%>
	<%
	String PG_TITLE = "集团成员变更列表"; // 浏览器窗口标题 <title> PG_TITLE </title>
	%>
<%/*~END~*/%>
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List04;Describe=定义按钮;]~*/%>
	...
	String sButtons[][] = {
		{"false","","Button","客户详情","查看关联企业成员客户信息详情","viewCustomer()",sResourcesPath},
		};
	%>
<%/*~END~*/%>
