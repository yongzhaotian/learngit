...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List01;Describe=定义页面属性;]~*/%>
	<%
	String PG_TITLE = "特许经营行业情况列表"; // 浏览器窗口标题 <title> PG_TITLE </title>
	%>
<%/*~END~*/%>
...
<%
	...
	String sTempletNo = "EspecialAuthList"; //模版编号
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List04;Describe=定义按钮;]~*/%>
	...
	String sButtons[][] = {
		{"true","All","Button","新增","新增特许经营情况","newRecord()",sResourcesPath},
		{"true","","Button","详情","查看特许经营情况","viewAndEdit()",sResourcesPath},
		{"true","All","Button","删除","删除特许经营情况","deleteRecord()",sResourcesPath},
		};
	%>
<%/*~END~*/%>
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	function viewAndEdit()
	{
		...
		sCustomerID   = getItemValue(0,getRow(),"CustomerId");//--客户号码
