...
<body>
<div class="mydiv" style="padding-bottom:10px;"><%@ include file="/Resources/CodeParts/ButtonSet.jsp"%></div>
...
<%
    ...
    ((TreeTableRenderer<FamilyTreeNode>)renderer).setHeaderSetting("{MemberName=名称,parentRelationType=关系,shareValue=持股比例(%)}");
    ((TreeTableRenderer<FamilyTreeNode>)renderer).setCodeSetting("{{id=root:根,1010:第一级}{parentRelationType=01:父子,02:兄弟}{parentRelationType=01:父子,02:兄弟}}");
