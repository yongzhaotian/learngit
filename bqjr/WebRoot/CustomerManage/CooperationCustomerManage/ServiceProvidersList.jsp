...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Info03;Describe=定义数据对象;]~*/%>
	<%
	 ...
	 String sTempletNo = "ServiceProvidersList";
	 doTemp = new ASDataObject(sTempletNo,Sqlca);//新增模型：2013-5-9}
	 doTemp.setColumnAttribute("serviceProvidersName,serviceProvidersType","IsFilter","1");
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List04;Describe=定义按钮;]~*/%>
	...
	String sButtons[][] = {
		...
		{"true","","Button","修改","修改","newEdit()",sResourcesPath},	
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	function newRecord(){
		OpenPage("/CustomerManage/CooperationCustomerManage/ServiceProvidersInfo1.jsp","_self","");
	}
	...
	function newEdit(){
		...
		AsControl.OpenView("/CustomerManage/CooperationCustomerManage/ServiceProvidersTab.jsp","serialNo="+sSerialNo,"_blank");
		reloadSelf();
	}
