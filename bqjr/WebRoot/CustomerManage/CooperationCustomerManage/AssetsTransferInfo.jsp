...
%>
<%
	String PG_TITLE = "新增资产转让受让方"; // 浏览器窗口标题 <title> PG_TITLE </title>
%>
<%
	/*~END~*/
%>
...
%>
<%
	ASDataObject doTemp = new ASDataObject("AssetsTransferInfo",Sqlca);
...
<script type="text/javascript">
	...
	{
		OpenPage("/CustomerManage/CooperationCustomerManage/AssetsTransferList.jsp","_self","");
	}
...
<script type="text/javascript">
	...
	function initRow(){
		if (getRowCount(0)==0) //如果没有找到对应记录，则新增一条，并设置字段默认值
		{
			...
			setItemValue(0, 0, "customerType1", "02");
