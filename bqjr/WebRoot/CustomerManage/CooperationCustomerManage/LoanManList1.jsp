<%@ page contentType="text/html; charset=GBK"%><%@
 include file="/IncludeBegin.jsp"%><%
	...
	String sTempletNo = "LoanManList1";//模型编号
...
<script type="text/javascript">
	function newRecord(){
		AsControl.OpenView("/CustomerManage/CooperationCustomerManage/LoanManInfo1.jsp","","_self","");
	...
	function viewAndEdit(){
		...
		AsControl.OpenView("/CustomerManage/CooperationCustomerManage/LoanManTab1.jsp","serialNo="+sSerialNo,"_blank","");
		reloadSelf();
	}
