...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Info03;Describe=定义数据对象;]~*/%>
	<%
	 ...
	 String sTempletNo = "AssetsTransferList";
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	function newRecord(){
		OpenPage("/CustomerManage/CooperationCustomerManage/AssetsTransferInfo.jsp","_self","");
	...
	function newDetail(){
		...
		AsControl.OpenView("/CustomerManage/CooperationCustomerManage/AssetsTransferDetailsInfo.jsp","serialNo="+sSerialNo,"right");
