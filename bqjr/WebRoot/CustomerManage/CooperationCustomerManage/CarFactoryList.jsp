...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Info03;Describe=定义数据对象;]~*/%>
	<%
	 ...
	 String sTempletNo = "CarFactoryList";
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	function newRecord(){
		OpenPage("/CustomerManage/CooperationCustomerManage/CarFactoryInfo.jsp","_self","");
	...
	function newDetail(){
		...
		AsControl.OpenView("/CustomerManage/CooperationCustomerManage/CarFactoryDetails.jsp","serialNo="+sSerialNo,"_blank");
		reloadSelf();
	}
