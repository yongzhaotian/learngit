...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List00;Describe=注释区;]~*/%>
	...
	/*
		...
		Tester:
		Describe: 一般担保合同列表（有效的）（一个保证合同对应一个保证人）;
		Input Param:
...
<%
	...
	String sTempletNo = "ValidAssureList1";//模型编号
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List04;Describe=定义按钮;]~*/%>
	...
	String sButtons[][] = {		
		...
		{"false","","Button","担保失效","失效担保合同","statusChange()",sResourcesPath},
		};
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	function viewAndEdit()
	{
		...
		if(typeof(sSerialNo)=="undefined" || sSerialNo.length==0) {
			...
			OpenPage("/CreditManage/CreditAssure/ValidAssureInfo1.jsp?SerialNo="+sSerialNo+"&GuarantyType="+sGuarantyType,"right");
		}
	}
