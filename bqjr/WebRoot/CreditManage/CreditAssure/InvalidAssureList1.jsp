...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List00;Describe=注释区;]~*/%>
	...
	/*
		...
		Tester:
		Describe: 一般担保合同列表（失效的）（一个保证合同对应一个保证人）;
		Input Param:
...
<%
	...
	String sTempletNo = "InvalidAssureList1";//模型编号
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	function viewAndEdit()
	{
		...
		if(typeof(sSerialNo)=="undefined" || sSerialNo.length==0) {
			...
			OpenPage("/CreditManage/CreditAssure/InvalidAssureInfo1.jsp?SerialNo="+sSerialNo+"&GuarantyType="+sGuarantyType,"right");
		}
	}
