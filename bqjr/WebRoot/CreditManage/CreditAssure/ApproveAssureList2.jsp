...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List00;Describe=注释区;]~*/%>
	...
	/*
		...
		Tester:
		Describe: 最终审批意见所对应的拟引入的担保合同列表（一个保证合同对应一个保证人）;
		Input Param:
...
<%
	...
	String sTempletNo = "ApproveAssureList2";
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	function viewAndEdit(){
		...
		if(typeof(sSerialNo)=="undefined" || sSerialNo.length==0) {
			...
			OpenPage("/CreditManage/CreditAssure/ApproveAssureInfo2.jsp?SerialNo="+sSerialNo+"&GuarantyType="+sGuarantyType,"right");
		}
	}
