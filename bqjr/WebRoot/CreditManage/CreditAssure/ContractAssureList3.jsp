...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List00;Describe=注释区;]~*/%>
	...
	/*
		...
		Tester:
		Describe: 业务合同所对应的新增的担保合同列表（一个保证合同对应多个保证人）;
		Input Param:
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	function newRecord()
	{
		...
		{
			OpenPage("/CreditManage/CreditAssure/ContractAssureInfo3.jsp?GuarantyType="+sGuarantyType,"right");
		}
	}
	...
	function viewAndEdit()
	{
		...
		}else 
		{
			...
			OpenPage("/CreditManage/CreditAssure/ContractAssureInfo3.jsp?SerialNo="+sSerialNo+"&GuarantyType="+sGuarantyType,"right");
		}
	}
	...
	function mySelectRow()
	{
		...
		}else
		{
			...
			if (sGuarantyType.substring(0,3) == "010") //保证
				OpenPage("/CreditManage/GuarantyManage/ContractGuarantorList1.jsp?ObjectType=<%=sObjectType%>&ObjectNo=<%=sObjectNo%>&ContractNo="+sSerialNo,"DetailFrame","");
