...
<%
    ...
    String sTempletNo = "ApproveAssureList1";
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List04;Describe=定义按钮;]~*/%>
	...
	String sButtons[][] = {
		{"true","All","Button","新增","新增担保信息","newRecord()",sResourcesPath}, 
		{"true","","Button","详情","查看担保信息详情","viewAndEdit()",sResourcesPath},
		{"true","All","Button","删除","删除担保信息","deleteRecord()",sResourcesPath}, 
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	function newRecord()
	{
		...
		{
			OpenPage("/CreditManage/CreditAssure/ApproveAssureInfo1.jsp?GuarantyType="+sGuarantyType,"right");
		}
	}
	...
	function viewAndEdit()
	{
		...
		}else 
		{
			...
			OpenPage("/CreditManage/CreditAssure/ApproveAssureInfo1.jsp?SerialNo="+sSerialNo+"&GuarantyType="+sGuarantyType,"right");
		}
	}
