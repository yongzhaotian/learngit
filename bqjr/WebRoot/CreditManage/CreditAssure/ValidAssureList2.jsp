...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List00;Describe=注释区;]~*/%>
	...
	/*
		...
		Tester:
		Describe: 最高额担保合同列表（有效的）（一个保证合同对应一个保证人）;
		Input Param:
				
		Output Param:
				
		HistoryLog:  pwang 2009-08-13 增加新增按钮
...
<%
	//通过DW模型产生ASDataObject对象doTemp
		String sTempletNo = "ValidAssureList2";//模型编号
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List04;Describe=定义按钮;]~*/%>
	...
	String sButtons[][] = {	
		{"true","","Button","新增","新增最高额担保合同","newContract()",sResourcesPath},
		...
		{"true","","Button","担保合同余额","查询担保合同余额","getGuarantyBalance()",sResourcesPath},
		};
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	/*~[Describe=新增最高额担保合同;InputParam=无;OutPutParam=无;]~*/
	...
	function viewAndEdit(){
		...
		var sSerialNo = getItemValue(0,getRow(),"SerialNo");//担保合同编号
	...
	/*~[Describe=查询担保合同担保余额;InputParam=无;OutPutParam=无;]~*/
	function getGuarantyBalance(){
		...
		alert("担保余额:￥"+amarMoney(balance,2));
	}
