...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List01;Describe=定义页面属性;]~*/%>
	<%
	String PG_TITLE = "相关贸易单据信息"; // 浏览器窗口标题 <title> PG_TITLE </title>
	%>
<%/*~END~*/%>
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List04;Describe=定义按钮;]~*/%>
	...
	String sButtons[][] = {
		{"true","","Button","新增","新增贸易单据信息","newRecord()",sResourcesPath},
		{"true","","Button","详情","查看贸易单据详情","viewAndEdit()",sResourcesPath},
		{"true","","Button","删除","删除贸易单据信息","deleteRecord()",sResourcesPath}
		};
	%>
<%/*~END~*/%>
