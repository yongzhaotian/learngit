...
<%
	...
	String sTempletNo = "RelativeLC2List";//模型编号
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	function newRecord()
	{
		OpenPage("/CreditManage/CreditApply/RelativeAllLCInfo.jsp?Templet=CKLCInfo","_self","");
	}
	...
	function viewAndEdit()
	{
		...
		if(typeof(sSerialNo)=="undefined" || sSerialNo.length==0) {
			...
			OpenPage("/CreditManage/CreditApply/RelativeAllLCInfo.jsp?Templet=CKLCInfo&SerialNo="+sSerialNo, "_self","");
		}
	}
