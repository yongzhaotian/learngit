...
<%
	...
	String sTempletNo = "OtherLoanApplyMassageInfo";//模型编号
...
<script type="text/javascript">
	...
	function goBack(){
		AsControl.OpenView("/CreditManage/CreditApply/OtherLoanApplyMassageList.jsp","","_self");
	}
	...
	function initRow(){
		if (getRowCount(0)==0){//如当前无记录，则新增一条
			as_add("myiframe0");
			bIsInsert = true;
			setItemValue(0,0,"SERIALNO",getSerialNo("OTHER_LOAN_MASSAGE", "SERIALNO", " "));
			setItemValue(0,0,"CONTRACTNO",<%=sObjectNo%>);
		}
    }
