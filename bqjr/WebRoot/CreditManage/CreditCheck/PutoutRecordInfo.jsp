...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Info01;Describe=定义页面属性;]~*/%>
	<%
	String PG_TITLE = "提款记录"; // 浏览器窗口标题 <title> PG_TITLE </title>
	%>
<%/*~END~*/%>
...
<%
	...
	String sItemNo = DataConvert.toRealString(iPostChange,(String)request.getParameter("ItemNo"));
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Info03;Describe=定义数据对象;]~*/%>
	<%
	 ...
	 String sTempletNo = "PutoutRecordInfo";
	...
	//生成HTMLDataWindow
	Vector vTemp = dwTemp.genHTMLDataWindow(sSerialNo+","+sObjectNo+","+sObjectType+","+sItemNo);//新增参数：2013-5-9
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=Info06;Describe=定义按钮事件;]~*/%>
	...
	function goBack()
	{
		OpenPage("/CreditManage/CreditCheck/PutoutRecordList.jsp?SerialNo=<%=sSerialNo%>","_self","");
	}
	</script>
<%/*~END~*/%>
