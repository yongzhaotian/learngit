...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List00;Describe=注释区;]~*/%>
	<%
	/*
		Author: xhgao 2005/09/05
		Tester:
		Content: 额度项下业务列表
		Input Param:
		Output param:
		History Log:
				2009.07.01 hwang 修改获取额度项下业务逻辑
...
<%
	...
	//获得组件参数	
	String sLineNo = DataConvert.toRealString(iPostChange,CurComp.getParameter("ObjectNo"));
	//将空值转化为空字符串
...
<%	
	...
	//生成HTMLDataWindow
	Vector vTemp = dwTemp.genHTMLDataWindow(sLineNo);
