...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	function newRecord()
	{
		...
		OpenPage("/CreditManage/GuarantyManage/ValidAssureImpawnInfo1.jsp?ContractNo=<%=sContractNo%>&ImpawnType="+sImpawnType,"_self");
	}
	...
	function viewAndEdit()
	{
		...
		{
			OpenPage("/CreditManage/GuarantyManage/ValidAssureImpawnInfo1.jsp?ContractNo=<%=sContractNo%>&GuarantyID="+sGuarantyID+"&ImpawnType="+sImpawnType,"_self");
		}
	}
