...
/* 	doTemp.setLimit("GuarantyRightID,AboutOtherID1,OtherGuarantyRight",30);
	...
	if(sGuarantyStatus.equals("01"))//未入库
	{
		//设置权利人选择框
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=Info07;Describe=自定义函数;]~*/%>
	...
	{			
		...
		sOwnerName = getItemValue(0,0,"OwnerName");//权利人名称

		//证件类型、证件代码、权利人名称只能允许两种情况出现，1、3个字段都有值，2、3个字段都没有值
		if(!((typeof(sCertType) != "undefined" && sCertType != "")&&
		   (typeof(sCertID) != "undefined" && sCertID != "")&&
		   (typeof(sOwnerName) != "undefined" && sOwnerName != ""))&&
		   !((typeof(sCertType) == "undefined" || sCertType == "")&&
		   (typeof(sCertID) == "undefined" || sCertID == "")&&
		   (typeof(sOwnerName) == "undefined" || sOwnerName == ""))
		   ){
			   alert("证件类型、证件代码、权利人名称必须同时有值，或者同时为空！");
			   return;
		} 
