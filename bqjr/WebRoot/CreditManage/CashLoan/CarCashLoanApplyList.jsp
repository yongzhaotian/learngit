	...
	*/
	...
	function newApply(){
		...
		if(confirm("当前登录所在门店为：\n\r"+sStore+"\n\r是否确认在该门店发起申请？")){
			var rValues=RunJavaMethodSqlca("com.amarsoft.app.billions.RetailStoreCommon", "getCreditID", "ProductType=3,citys="+ssCity);
			if(rValues=="false"){
			...
			//弹出新增申请参数对话框
		 	sCompID = "CarCashLoanApplyInfo";
			sCompURL = "/CreditManage/CashLoan/CarCashLoanApplyInfo.jsp";	 
