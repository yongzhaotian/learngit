...
<%	
	...
	//设置为只读
	doTemp.setReadOnly("CustomerName,SignalName,SignalTypeName,SignalStatusName,MessageOriginName,MessageContent",true);
	doTemp.setReadOnly("ActionFlagName,ActionTypeName,FreeFlag,Remark,InputOrgName,InputDate,InputUserName,UpdateDate",true);			
	//设置格式	
	doTemp.setHTMLStyle("CustomerName"," style={width:200px;} ");
	doTemp.setHTMLStyle("SignalTypeName,SignalStatusName"," style={width:35px;} ");
	doTemp.setHTMLStyle("SignalName"," style={width:400px;} ");
	doTemp.setHTMLStyle("InputUserName,InputDate,UpdateDate"," style={width:80px;} ");
	doTemp.setHTMLStyle("ActionFlagName,FreeFlag"," style={width:20px;} ");
