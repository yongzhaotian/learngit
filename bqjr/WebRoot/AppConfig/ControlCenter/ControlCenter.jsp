		  ...
		  <table border=0 cellpadding=0  cellspacing=0 style='cursor: pointer;' width='100%'>
			...
			<tr bgcolor='#EEEEEE' id=ConditonMap<%=i%>Tab valign=center height='20'> 
			  ...
			  <td align=left width='100%' valign='middle' onClick="javascript:document.getElementById('ConditonMap<%=i%>Tab3').click();"> 
				<table>
				  <tr> 
					<td> <font color=#000000 id=ConditonMap<%=i%>Tab2 >缓存控制台</font> 
					</td>
				  </tr>
				</table>
			  </td>
		...
		<td>
			<table width="100%" border="0" cellspacing="0" cellpadding="4">
			  <ul>
			  	<tr>
					<td>
						<li><a href="javascript:AsDebug.reloadConfigFile()">重载配置文件【<%=CurConfig.getConfigFile()%>】(需重新登录)</a></li>
			    	</td>
			  	</tr>
		  		<tr>
			    	<td>
				...
				%>				
			  	<tr>
				    <td>
				        <li><a href="javascript:AsDebug.reloadCache('<%=keys[iKey]%>')">刷新【<%=keys[iKey]%>】缓存</a></li>
				    </td>
			  	</tr>
				<%}%>
		      </ul>
		  ...
		  <table border=0 cellpadding=0  cellspacing=0 style='cursor: pointer;' width='100%'>
			...
			<tr bgcolor='#EEEEEE' id=ConditonMap<%=i%>Tab valign=center height='20'> 
			  ...
			  <td align=left width='100%' valign='middle' onClick="javascript:document.getElementById('ConditonMap<%=i%>Tab3').click();"> 
				<table>
				  <tr> 
					<td> <font color=#000000 id=ConditonMap<%=i%>Tab2 >系统属性参数</font> 
					</td>
				  </tr>
				</table>
			  </td>
  ...
  <tr> 
	...
	<tr>
		...
		<%
		  ...
		  Iterator<?> ir2 = ps.keySet().iterator();
		  for (int i2=1; ir2.hasNext();i2++) {
		      String sKey = (String) ir2.next();
		%>
		        <tr>
		          <td width="100%" >
		              <li>Property(<%=i2%>)[<%=sKey%>]=<strong>[<%=ps.getProperty(sKey)%>]</strong></li>
		          </td>
		        </tr>
		<%
		  }
		  ...
		  <table border=0 cellpadding=0  cellspacing=0 style='cursor: pointer;' width='100%'>
			...
			<tr bgcolor='#EEEEEE' id=ConditonMap<%=i%>Tab valign=center height='20'> 
			  ...
			  <td align=left width='100%' valign='middle' onClick="javascript:document.getElementById('ConditonMap<%=i%>Tab3').click();"> 
				<table>
				  <tr> 
					<td> <font color=#000000 id=ConditonMap<%=i%>Tab2 >系统环境参数</font> 
					</td>
				  </tr>
				</table>
			  </td>
  ...
  <tr> 
	...
	<tr>
		...
		<%
		  ...
		  for (int i1=1; ir.hasNext();i1++) {
		      String sKey = (String) ir.next();
		%>
				<tr>
				  <td width="100%" >
				      <li>Env(<%=i1%>)[<%=sKey%>]=<strong>[<%=envs.get(sKey)%>]</strong></li>
				  </td>
				</tr>
		<%
		  }
