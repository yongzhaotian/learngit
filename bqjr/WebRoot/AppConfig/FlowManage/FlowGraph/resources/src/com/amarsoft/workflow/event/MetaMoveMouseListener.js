...
MetaMoveMouseListener.prototype.onMouseMove = function (e) {
    ...
    if (this.lastCoord) {
        ...
        if ((curTime - this.lastTime) > WorkFlowWorkSpace.META_NODE_MOVED_STEP_TIME) {
            this.move(e);
...
MetaMoveMouseListener.prototype.move = function (e) {
    ...
    WorkFlowModel.moveMetaNodeModelBy(metaNodeModels, curCoord.getX() - this.lastCoord.getX(), curCoord.getY() - this.lastCoord.getY());
