 ...
 * @author
 */
function WorkFlowTableViewer(model, ui) {
...
WorkFlowTableViewer.prototype = new ScrollPanel();
WorkFlowTableViewer.prototype.setModel = function (model) {
    if (!model) {
        return;
    }
    if (this.model == model) {
...
WorkFlowTableViewer.prototype.getModel = function (model) {
    return this.model;
};
WorkFlowTableViewer.prototype.update = function (observable, arg) {
...
//
WorkFlowTableViewer.prototype.init = function () {
	//clear
    this.clearTable();
...
WorkFlowTableViewer.prototype.addMetaNodeModel = function (metaNodeModel) {
    if (!metaNodeModel) {
        return;
    }
    var row = this.addRow();
...
WorkFlowTableViewer.prototype.addRow = function () {
    var row = this.table.insertRow();
    this.rows.add(row);
    return row;
};
WorkFlowTableViewer.prototype.clearTable = function () {
    Toolkit.clearElement(this.table);
    this.rows.clear();
};
WorkFlowTableViewer.prototype.removeRow = function (row) {
    if (!row) {
        return;
    }
