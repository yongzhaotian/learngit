...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List04;Describe=定义按钮;]~*/%>
	...
	String sButtons[][] = {
			...
			{"true","","Button","合同档案登记","合同档案登记","contractRegistration()",sResourcesPath},
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	function fileEnd(){
		...
		var sCount =RunMethod("GetElement","GetElementValue","count(*),business_contract,boxID='"+sBoxID+"' and CreditAttribute='0001' and ContractRegistration='01'");//判断该箱子下是否已存在登记过 合同档案登记 
		if(typeof(sBoxID)=="undefined" || sBoxID.length==0){
			alert(getHtmlMessage(1));  //请选择一条记录！
			return;
		}
