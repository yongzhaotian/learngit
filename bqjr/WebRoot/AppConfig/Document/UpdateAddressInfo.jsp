...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	function saveRecord()
	{
		...
		var sBoxNumber1=getItemValue(0,getRow(),"BoxNumber1");
		var sBoxNumber2=getItemValue(0,getRow(),"BoxNumber2");
	    ...
	    if(parseFloat(sBoxNumber1)>parseFloat(sBoxNumber2)){
	    	alert("原箱子容量不能大于新箱子容量！");
	    	return;
	    }
    ...
    function selectOldBox(){
    	...
    	setItemValue(0,0,"BoxNumber1", sRetVal.split("@")[2]);
    }
    function selectNewBox(){
    	...
    	setItemValue(0,0,"BoxNumber2", sRetVal.split("@")[2]);
    }
	</script>
<%/*~END~*/%>
