...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List01;Describe=定义页面属性;]~*/%>
	<%
	String PG_TITLE = "临时借出页面"; // 浏览器窗口标题 <title> PG_TITLE </title>
	%>
<%/*~END~*/%>
...
<%	
	...
	ASDataObject doTemp = new ASDataObject("BoxNoLendCarInfo",Sqlca);
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	function selectContractInfo() {
		...
		setItemValue(0, 0, "CustomerName", sTypeArry[1]);//商品范畴名称
		return;
	}
