<%@ page contentType="text/html; charset=GBK"%><%@
 include file="/IncludeBegin.jsp"%><%
	/*
		--页面说明:示例模块主页面--
	 */
	String PG_TITLE = "归档管理"; // 浏览器窗口标题 <title> PG_TITLE </title>
	String PG_CONTENT_TITLE = "&nbsp;&nbsp;合同归档&nbsp;&nbsp;"; //默认的内容区标题
	...
	//定义Treeview
	HTMLTreeView tviTemp = new HTMLTreeView(SqlcaRepository,CurComp,sServletURL,"合同归档","right");
	...
	tviTemp.insertPage("root","未归档合同","",1);
	tviTemp.insertPage("root","已归档合同","",2);
	tviTemp.insertPage("root","超期未归还的调阅合同","",2);
...
<script type="text/javascript"> 
	...
	function initTreeView(){
		...
		expandNode('root');
		selectItemByName("未归档合同");	//默认打开的(叶子)选项	
	}
