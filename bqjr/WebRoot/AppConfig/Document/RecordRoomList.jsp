...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List01;Describe=定义页面属性;]~*/%>
	<%
	String PG_TITLE = "档案室维护"; // 浏览器窗口标题 <title> PG_TITLE </title>
	%>
<%/*~END~*/%>
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Info03;Describe=定义数据对象;]~*/%>
    ...
    if(sTemp==null) sTemp="";	
     ...
     String sTempletNo="RecordRoomList";
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	function newRecord(){
		AsControl.OpenView("/AppConfig/Document/RecordRoomInfo.jsp","","_self");		
	...
	function newDetail(){
		...
		AsControl.OpenView("/AppConfig/Document/RecordRoomInfo.jsp","cabinetID="+sCabinetID+"&temp=modify","_self");
	}
	...
	function deleteRecord(){
		...
		var sCount=RunMethod("Unique","uniques","archives_Warehouse,count(1),CreditAttribute='0002' and CodeAttribute='LineNumberCode' and SNO='"+sCabinetID+"'");
		if(sCount>"0.0"){
			alert("该档案室下已存在行,不能删除！");
		}else{
