...
<body class="ListPage" leftmargin="0" topmargin="0" >
 <table>
         <tr>
               <td>上一次质量等级:</td>
               <td><%=sRelativeQualityGrade %></td>
         </tr>
         <tr>
               <td>当前质量等级:</td>
               <td><%=sNowQualityGrade %></td>
         </tr>
         <tr>
               <td>上一次地标:</td>
               <td><%=oldLandmark %></td>
...
%>
	<tr>
		...
		<div id="divDrag" class="divDrag" title="驴脡脥脧脳搂赂脛卤盲麓掳驴脷麓贸脨隆" style="height:1px;width:100%;font-size:0;z-index:0;cursor:n-resize;"></div>
	    </td>
	</tr>
	<tr>
