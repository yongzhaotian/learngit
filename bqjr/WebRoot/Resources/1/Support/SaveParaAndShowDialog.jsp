...
<%
	String sTempPostAction = (String)CurPage.getParameter("TempPostAction");
	String sTempParaString = (String)CurPage.getParameter("TempParaString");
	String sParas[][];
	int iParas = 0;
	if(sTempParaString!=null && !sTempParaString.equals(""))
	{
		...
		for(int i=0;i<sParas.length;i++){
			...
			CurComp.setAttribute(sParas[i][0],sParas[i][1]);
		}
	}
%>
