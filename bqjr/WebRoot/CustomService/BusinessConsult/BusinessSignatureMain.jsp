<%@ page contentType="text/html; charset=GBK"%><%@
 include file="/IncludeBegin.jsp"%><%
	/*
		页面说明:示例模块主页面
	 */
	String PG_TITLE = "电子合同签章"; // 浏览器窗口标题 <title> PG_TITLE </title>
	String PG_CONTENT_TITLE = "&nbsp;&nbsp;电子合同签章&nbsp;&nbsp;"; //默认的内容区标题
	...
	//定义Treeview
	HTMLTreeView tviTemp = new HTMLTreeView(SqlcaRepository,CurComp,sServletURL,"电子合同签章","right");
	...
	tviTemp.insertPage("root","待处理","",1);
	tviTemp.insertPage("root","已处理","",2);
