...
<%
	...
	String sTempletNo = "DelayApplyBOMTRInfo";//模型编号
...
<script type="text/javascript">
	function initRow() {
		if (getRowCount(0) == 0) { // 如果没有找到对应记录，则新增一条，并设置字段默认值
			as_add("myiframe0");
			setItemValue(0, 0, "ALTER_TYPE", "00");
			setItemValue(0, 0, "ALTER_VALUE", "1");
	...
	function saveRecord() {
		...
		setItemValue(0, 0, "ALTER_PAYDATE", alterPayDate);
	...
	function alterValueOnchange() {
		...
		var params = "alterType=" + alterType + ",alterValue=" + alterValue + ",curPayDate=" + curPayDate;
		var result = RunJavaMethodSqlca("com.amarsoft.app.lending.bizlets.BOMTRApplyCheck", "queryAlterPayDate", params);		// 校验返回结果
		if (result.split("@")[0] == "false") {
			...
			setItemValue("0", "0", "ALTER_PAYDATE", opts.split(",")[0]);
		}
	}
