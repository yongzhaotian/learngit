...
<body bgcolor="#D3D3D3">
<form name="SelectAttachment" method="post" ENCTYPE="multipart/form-data" action="<%=sWebRootPath%>/CustomService/BusinessConsult/ChannelListUpload.jsp?CompClientID=<%=CurComp.getClientID()%>" align="center">
<table align="center">
	<tr>
    	...
    	<tr>
    		<td>   
    			<font size="2">导入方式:</font><input type="radio" name="uploadType" value='append' checked>只导入新增数据
    			<input type="radio" name="uploadType" value="cover">导入并覆盖原数据
    		</td>
    	</tr>
      	<tr>
      		<td>
