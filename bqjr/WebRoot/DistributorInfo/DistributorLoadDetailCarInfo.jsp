...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List01;Describe=定义页面属性;]~*/%>
	<%
	String PG_TITLE = "新增车辆信息"; // 浏览器窗口标题 <title> PG_TITLE </title>
	%>
<%/*~END~*/%>
...
<%
	//获得页面参数
	String sSerialNo = DataConvert.toRealString(iPostChange,(String)CurComp.getParameter("serialNo"));	//上级流水号
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List04;Describe=定义按钮;]~*/%>
	...
	String sButtons[][] = {
			...
			{"true","","Button","返回","返回列表","backList()",sResourcesPath},
		    };
	%> 
<%/*~END~*/%>
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
    ...
    function getRegionCode(){
    	...
    	setItemValue(0, 0, "carFactoryID", sRetVal[0]);  //关联车厂ID
		setItemValue(0, 0, "carFactory", sRetVal[1]);    //所属车厂
    }
	</script>
<%/*~END~*/%>
