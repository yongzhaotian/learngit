...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List01;Describe=定义页面属性;]~*/%>
	<%
	String PG_TITLE = "经销商借款详情"; // 浏览器窗口标题 <title> PG_TITLE </title>
	%>
<%/*~END~*/%>
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List04;Describe=定义按钮;]~*/%>
	...
	String sButtons[][] = {
			...
			{"true","","Button","修改","修改信息记录","modifyDetail()",sResourcesPath},
			{"true","","Button","删除","删除信息记录"," deleteRecord()",sResourcesPath},
			{"true","","Button","导入车辆信息","导入车辆信息","",sResourcesPath},
		    };
	%> 
<%/*~END~*/%>
