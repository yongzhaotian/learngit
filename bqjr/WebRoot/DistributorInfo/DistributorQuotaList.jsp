...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List01;Describe=定义页面属性;]~*/%>
	<%
	String PG_TITLE = "经销商额度管理 "; // 浏览器窗口标题 <title> PG_TITLE </title>
	%>
<%/*~END~*/%>
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List04;Describe=定义按钮;]~*/%>
	...
	String sButtons[][] = {
		{"true","","Button","新增经销商额度","新增经销商额度","newRecord()",sResourcesPath},
		{"true","","Button","查看/修改额度详情","查看/修改额度详情","modifyDetail()",sResourcesPath},	
		{"true","","Button","文件上传和扫描","文件上传和扫描","d()",sResourcesPath},
		{"true","","Button","额度启用","额度启用","enableMoney()",sResourcesPath},
		{"true","","Button","查看保证金信息","查看保证金信息","enable()",sResourcesPath}
		};
	%>
<%/*~END~*/%>
