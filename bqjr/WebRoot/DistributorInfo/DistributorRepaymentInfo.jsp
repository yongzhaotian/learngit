...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List01;Describe=定义页面属性;]~*/%>
	<%
	String PG_TITLE = "查看对应借款合同 "; // 浏览器窗口标题 <title> PG_TITLE </title>
	%>
<%/*~END~*/%>
...
<%	
	String sTempletNo = "DistributorRepaymentInfo";
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	function saveRecordAndBack(){
    	if("<%=sTemp %>" =="1"){
    		AsControl.OpenView("/DistributorInfo/DistributorRepaymentList.jsp","","_self");
    	}else{
