...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Main01;Describe=定义页面属性;]~*/%>
	...
	String PG_CONTENT_TITLE = "&nbsp;&nbsp;库存还款管理&nbsp;&nbsp;"; //默认的内容区标题
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Main03;Describe=定义树图;]~*/%>
	<%
	//定义Treeview
	HTMLTreeView tviTemp = new HTMLTreeView(SqlcaRepository,CurComp,sServletURL,"库存还款管理","right");
	...
	String sSqlTreeView = "from CODE_LIBRARY where CodeNo= 'DistributorRepaymentMain' and IsInUse = '1' ";
...
<script type="text/javascript"> 
	...
	function TreeViewOnClick()
	{
		...
		if(sCurItemDescribe1 != "null" && sCurItemDescribe1 != "root"){
			OpenComp(sCurItemDescribe2,sCurItemDescribe1,"","right");
