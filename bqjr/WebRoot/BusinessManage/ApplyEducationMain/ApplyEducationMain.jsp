...
<%/*~BEGIN~可编辑区[Editable=true;CodeAreaID=Main05;Describe=树图事件;]~*/%>
    ...
    function TreeViewOnClick()
    {
        ...
        if(sCurItemDescribe1 != "root")
        {
            ...
            AsControl.OpenComp(sCurItemDescribe1,"ComponentName=授信申请列表&ApplyType=<%=sApplyType%>&SubApplyType=<%=sSubApplyType%>&PhaseType="+getCurTVItem().id+"&ViewId="+sCurItemDescribe3,"right");
