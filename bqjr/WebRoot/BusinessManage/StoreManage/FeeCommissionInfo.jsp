...
<%
	...
	String sTempletNo = "FeeCommissionsInfo";//模型编号
...
<script type="text/javascript">
	...
	function saveRecord(sPostEvents){
		...
		RunMethod("ProductManage","UpdateCommission",sBASEAMOUNT+","+sSERVICERATIO+","+sFIXSERVICEAMOUNT+","+sCOMMISSIONRATIO+","+sFIXCOMMISSIONAMOUNT+","+sCOMSPSTARTDATE+","+sCOMSPENDDATE+","+sSERIALNO);
	...
	function goBack(){
		...
		//AsControl.OpenView("/BusinessManage/StoreManage/ProductList.jsp", "SSerialNo=<%=sSSerialNo %>", "_self","");
		self.close();
