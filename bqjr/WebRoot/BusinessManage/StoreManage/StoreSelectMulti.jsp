<%@ page contentType="text/html; charset=GBK"%><%@
 include file="/IncludeBegin.jsp"%><%
	...
	String sTempletNo = "StoreList";
	ASDataObject doTemp = new ASDataObject(sTempletNo,Sqlca);
	doTemp.multiSelectionEnabled=true;//设置可多选
	String sVisibleFields = "OPERATEMODE,STORETYPE,BUSINESSTYPE,TEL,ACCOUNT,ACCOUNTNAME,ACCOUNTBANK," +
		"PRODUCTCATEGORY,MAINBUSINESSTYPE,SALESMANEMAIL,REPONSIBLEMAN,REPONSIBLEMANPHONE,REMARK,RSERIALNO,STATUSNAME,GROUPNO,PERMITTYPE,SALESMANAGER,ISPOST,FINANCIALEMAIL";
	doTemp.setVisible(sVisibleFields, false);
	...
	function test(){
		...
		try{
			...
			for(var iMSR = 0 ; iMSR < b ; iMSR++){
				...
				if(a == "√"){
					sReturnValue = sReturnValue+getItemValue(0,iMSR,"SERIALNO")+"@";
				}
			}
		}catch(e){
			return;
