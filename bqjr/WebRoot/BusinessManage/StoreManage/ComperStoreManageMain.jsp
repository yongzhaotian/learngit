<%@ page contentType="text/html; charset=GBK"%><%@
 include file="/IncludeBegin.jsp"%><%
	/*
		页面说明:示例模块主页面
	 */
	String PG_TITLE = "门店查询"; // 浏览器窗口标题 <title> PG_TITLE </title>
	...
	//获得页面参数
	//定义Treeview
	HTMLTreeView tviTemp = new HTMLTreeView(SqlcaRepository,CurComp,sServletURL,"门店查询","right");
	...
	tviTemp.insertPage("root","门店列表","",1);
...
<script type="text/javascript"> 
	...
	function TreeViewOnClick(){
		...
		if(sCurItemname=='门店列表'){
			AsControl.OpenView("/BusinessManage/StoreManage/ComperStoreList.jsp","","right");
		}else{
			return;
		}
	...
	function initTreeView(){
		...
		expandNode('root');
		selectItem(1);
		selectItemByName("门店列表");	//默认打开的(叶子)选项	
	}
