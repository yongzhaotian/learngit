<%@ page contentType="text/html; charset=GBK"%><%@
 include file="/IncludeBegin.jsp"%><%
	...
	String PG_CONTENT_TITLE = "&nbsp;&nbsp;销售人员管理&nbsp;&nbsp;"; //默认的内容区标题
	...
	tviTemp.insertPage("root","销售人员管理","",1);
...
<script type="text/javascript"> 
	function TreeViewOnClick(){
		...
		if(sCurItemname=='销售人员管理'){
			AsControl.OpenView("/BusinessManage/CollectionManage/SalesManList.jsp","","right");
	...
	function initTreeView(){
		...
		expandNode('root');
		selectItemByName("销售人员管理");	//默认打开的(叶子)选项	
	}
