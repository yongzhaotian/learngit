...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Info01;Describe=定义页面属性;]~*/%>
	<%
	String PG_TITLE = "新增核销信息"; // 浏览器窗口标题 <title> PG_TITLE </title>
	%>
<%/*~END~*/%>
...
<%
	//定义变量
	String sTempletNo = "VerificationInfo";	
	//获得组件参数，客户代码
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=Info06;Describe=定义按钮事件;]~*/%>
	...
	{
		//设置返回参数 
		setObjectValue("selectContractNo","","@ContractSerialno@0@BusinessSum@1@DealerName@2@Balance@3",0,0,"");
	}
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=Info07;Describe=自定义函数;]~*/%>
	...
	{
		var sTableName = "verification_info";//表名
