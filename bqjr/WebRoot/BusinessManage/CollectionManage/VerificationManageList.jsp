...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List01;Describe=定义页面属性;]~*/%>
	<%
	String PG_TITLE = "待处理的合同列表"; // 浏览器窗口标题 <title> PG_TITLE </title>
	%>
<%/*~END~*/%>
...
<%	
	...
	String sTempletNo = "VerificationList"; //模版编号
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List04;Describe=定义按钮;]~*/%>
	...
	String sButtons[][] = {
			{"true","","Button","新增减免和核销信息","新增减免和核销信息","myAdd()",sResourcesPath},
			{"true","","Button","查看修改详情","查看修改详情","viewAndEdit()",sResourcesPath},
			{"true","","Button","发送财务","核销信息发送财务","",sResourcesPath},
		};
	%> 
<%/*~END~*/%>
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	function viewAndEdit()
	{
		...
		{
			sCompID = "VerificationManageInfo";
			sCompURL = "/BusinessManage/CollectionManage/VerificationManageInfo.jsp";
	...
	/*~[Describe=新增减免和核销信息;InputParam=无;OutPutParam=无;]~*/
	function myAdd()
	{ 	 
		sCompID = "VerificationManageInfo";
		sCompURL = "/BusinessManage/CollectionManage/VerificationManageInfo.jsp";
