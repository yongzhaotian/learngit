<%@ page contentType="text/html; charset=GBK"%><%@
 include file="/IncludeBegin.jsp"%><%
	...
	String sButtons[][] = {
		...
		{"true","","Button","详情","查看催收录入/修改详情","viewAndEdit()",sResourcesPath},
		{"true","","Button","案件转移","案件转移","viewAndEdit()",sResourcesPath},
		{"true","","Button","生成法诉材料","生成法诉材料","viewAndEdit()",sResourcesPath},
		{"true","","Button","法诉台账录入","法诉台账录入","viewAndEdit()",sResourcesPath},
	};
