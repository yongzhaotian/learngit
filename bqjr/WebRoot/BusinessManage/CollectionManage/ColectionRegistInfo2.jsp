...
<script type="text/javascript">
	...
	function saveRecord(sPostEvents){
		...
		var sReturn = AsControl.RunJavaMethodSqlca("com.amarsoft.app.hhcf.after.colection.AfterColectionAction","updateCarColectionRegist2","RegistSerialNo="+sSerialNo);
		if(sReturn != "Success"){
	...
	function goBack(){
		AsControl.OpenPage("/BusinessManage/CollectionManage/ColectionRegistList2.jsp","ContractSerialNo=<%=sBcSerialNo%>&ColectionSerialNo=<%=sColSerialNo%>","_self","");
	}
