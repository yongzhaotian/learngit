<%@ page contentType="text/html; charset=GBK"%><%@
 include file="/IncludeBegin.jsp"%><%
	/*
		页面说明:示例模块主页面
	 */
	String PG_TITLE = "委外催收"; // 浏览器窗口标题 <title> PG_TITLE </title>
	...
	//定义Treeview
	HTMLTreeView tviTemp = new HTMLTreeView(SqlcaRepository,CurComp,sServletURL,"委外催收主页面","right");
	...
	tviTemp.insertPage("root","待委外","",1);
	tviTemp.insertPage("root","已委外","",2);
	tviTemp.insertPage("root","待委外(提前委外)","",3);
	tviTemp.insertPage("root","已委外(提前委外)","",4);
