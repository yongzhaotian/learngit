<%@ page contentType="text/html; charset=GBK"%><%@
 include file="/IncludeBegin.jsp"%><%
	...
	String sTempletNo = "RepaymentChannelList";//模型编号
	...
	//生成HTMLDataWindow
	Vector vTemp = dwTemp.genHTMLDataWindow(sLoanNo); // modify   wlq   
...
<script type="text/javascript">
	function newRecord(){
		AsControl.OpenView("/BusinessManage/CollectionManage/RepaymentChannelInfo.jsp","LoanNo=<%=sLoanNo %>","_self","");
	}
	...
	function viewAndEdit(){
		...
		AsControl.OpenView("/BusinessManage/CollectionManage/RepaymentChannelInfo.jsp","SerialNo="+sSerialNo,"_self","");
	}
