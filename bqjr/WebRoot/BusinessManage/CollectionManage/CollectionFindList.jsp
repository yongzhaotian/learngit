...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List01;Describe=定义页面属性;]~*/%>
	<%
	String PG_TITLE = "催收查询"; // 浏览器窗口标题 <title> PG_TITLE </title>
	%>
<%/*~END~*/%>
...
<%	
	...
	String sTempletNo = "CollectionFindList"; //模版编号
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List04;Describe=定义按钮;]~*/%>
	...
	String sButtons[][] = {
			...
			{"true","","Button","逾期客户合同查询","逾期客户合同查询","viewOverdueContract()",sResourcesPath},
			{"true","","Button","催收历史查询","催收历史查询","viewConlletionHistory()",sResourcesPath},
		};
	%> 
<%/*~END~*/%>
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	function viewAndEdit()
	{
		...
		{
			OpenPage("/BusinessManage/CollectionManage/CollectionRecodeInfo.jsp?SerialNo="+sSerialNo+"&flag=N", "_self","");
		}
	}
	/*~[Describe=催收历史查询;InputParam=无;OutPutParam=无;]~*/
	function viewConlletionHistory(){
