<%@ page contentType="text/html; charset=GBK"%><%@
 include file="/IncludeBegin.jsp"%><%
	/*
		页面说明:示例模块主页面
	 */
	String PG_TITLE = "资产筛选管理"; // 浏览器窗口标题 <title> PG_TITLE </title>
	String PG_CONTENT_TITLE = "&nbsp;&nbsp;审批配置&nbsp;&nbsp;"; //默认的内容区标题
	...
	//定义Tree/iew
	HTMLTreeView tviTemp = new HTMLTreeView(SqlcaRepository,CurComp,sServletURL,"资产筛选管理","right");
	...
	tviTemp.insertPage("root","资产筛选管理","",1);
...
<script type="text/javascript"> 
	function TreeViewOnClick(){
		...
		if(sCurItemname=='资产筛选管理'){
			AsControl.OpenView("/BusinessManage/CollectionManage/TransferAutoDealList.jsp","","right");
		}else{
			return;
		}
	...
	function initTreeView(){
		...
		expandNode('root');
		selectItem(1);
		selectItemByName("资产筛选管理");	//默认打开的(叶子)选项	
	}
	initTreeView();
</script>
