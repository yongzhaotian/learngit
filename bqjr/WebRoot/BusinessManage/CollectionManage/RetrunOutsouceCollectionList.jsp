...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List01;Describe=定义页面属性;]~*/%>
	<%
	String PG_TITLE = "退回的委外业务"; // 浏览器窗口标题 <title> PG_TITLE </title>
	%>
<%/*~END~*/%>
...
<%	
	...
	String sTempletNo = "RetrunCollectionList"; //模版编号
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List04;Describe=定义按钮;]~*/%>
	...
	String sButtons[][] = {
			...
			{"true","","Button","移交法务处理","移交法务处理","gotoLaws()",sResourcesPath},
			{"true","","Button","移交核销处理","移交核销处理","gotoVerification()",sResourcesPath},
		};
	%> 
<%/*~END~*/%>
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	/*~[Describe=移交法务;InputParam=无;OutPutParam=无;]~*/
	function gotoLaws(){
		...
		var sRec = AsControl.RunJavaMethodSqlca("com.amarsoft.app.hhcf.after.colection.AfterColectionAction","gotoLaws","ColSerialNo="+sSerialNo);
		if(sRec!="true"){
			alert("该催收任务移交法务失败!");
			return;
		}
	...
	/*~[Describe=移交核销;InputParam=无;OutPutParam=无;]~*/
