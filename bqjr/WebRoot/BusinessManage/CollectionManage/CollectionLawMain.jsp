<%@ page contentType="text/html; charset=GBK"%><%@
 include file="/IncludeBegin.jsp"%><%
	...
	//定义Treeview
	HTMLTreeView tviTemp = new HTMLTreeView(SqlcaRepository,CurComp,sServletURL,"法务催收主页面","right");
	...
	tviTemp.insertPage("root","法务催收","",1);
...
<script type="text/javascript"> 
	...
	function TreeViewOnClick(){
		...
		if(sCurItemname=='法务催收')
		{
			AsControl.OpenView("/BusinessManage/CollectionManage/ConsumeCollectionLawList.jsp","PhaseType1=0040","right");
		}else
		{
			return;
		}
