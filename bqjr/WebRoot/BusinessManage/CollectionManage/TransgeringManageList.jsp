...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List01;Describe=定义页面属性;]~*/%>
	<%
	String PG_TITLE = "转售中的车辆"; // 浏览器窗口标题 <title> PG_TITLE </title>
	%>
<%/*~END~*/%>
...
<%	
	...
	String sTempletNo = "TransgeringManageList"; //模版编号
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List04;Describe=定义按钮;]~*/%>
	...
	String sButtons[][] = {
		   {"true","","Button","补登实际成交价","补登实际成交价","",sResourcesPath},
		   {"true","","Button","转售收款","转售收款","",sResourcesPath},
		   {"true","","Button","提交","提交","",sResourcesPath},
		};
	%> 
<%/*~END~*/%>
