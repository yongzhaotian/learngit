...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List01;Describe=定义页面属性;]~*/%>
	<%
	String PG_TITLE = "车型维护"; // 浏览器窗口标题 <title> PG_TITLE </title>
	%>
<%/*~END~*/%>
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List04;Describe=定义按钮;]~*/%>
	...
	String sButtons[][] = {
		...
		{"true","","Button","导入","导入","introduction()",sResourcesPath},	
		{"true","","Button","详情","查看记录详情","viewRecord()",sResourcesPath},	
		};
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	/*~[Describe=查看记录;InputParam=无;OutPutParam=无;]~*/
	function viewRecord(){
		var sModelsID =getItemValue(0,getRow(),"modelsID");//获取删除记录的单元值
