...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List01;Describe=定义页面属性;]~*/%>
	<%
	String PG_TITLE = "产品允许的经销商"; // 浏览器窗口标题 <title> PG_TITLE </title>
	%>
<%/*~END~*/%>
...
<%	
	ASDataObject doTemp = new ASDataObject("CBusinessTypeDistributorList",Sqlca);
	doTemp.setColumnAttribute("customerID,entErpriseName,distributorType","IsFilter","1");
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	function newRecord()
	{
		sCompID = "DistributorList";
		sCompURL = "/DistributorInfo/DistributorList.jsp";
	    popComp(sCompID,sCompURL,"temp=3","dialogWidth=660px;dialogHeight=460px;resizable=no;scrollbars=no;status:yes;maximize:no;help:no;");
	    reloadSelf();
	}
