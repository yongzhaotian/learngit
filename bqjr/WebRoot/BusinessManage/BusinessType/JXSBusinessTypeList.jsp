...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List01;Describe=定义页面属性;]~*/%>
	<%
	String PG_TITLE = "经销商产品管理"; // 浏览器窗口标题 <title> PG_TITLE </title>
	%>
<%/*~END~*/%>
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Info03;Describe=定义数据对象;]~*/%>
	<%
	 ...
	 String sTempletNo = "JXSBusinessTypeList";
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	function newRecord(){
		popComp("JXSBusinessTypeInfo","/BusinessManage/BusinessType/JXSBusinessTypeInfo.jsp","","dialogWidth=300px;dialogHeight=360px;resizable=no;scrollbars=no;status:yes;maximize:no;help:no;");
        reloadSelf();
	}
	...
	function productConfigure(){
    	...
    	popComp("JXSBusinessTypeInfo1","/BusinessManage/BusinessType/JXSBusinessTypeInfo1.jsp","typeNo="+sTypeNo,"");
    	reloadSelf();
	}
