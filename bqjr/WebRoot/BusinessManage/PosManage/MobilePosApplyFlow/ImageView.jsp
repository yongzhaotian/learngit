...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=View02;Describe=定义变量，获取参数;]~*/%>
	...
	String sTreeViewTemplet = "MobilePosApplyFileView";//
...
<%/*~BEGIN~可编辑区[Editable=true;CodeAreaID=View05;]~*/%>
	...
	function openChildComp(sCompID,sURL,sParameterString){
		...
		sParaStringTmp += "ToInheritObj=y&OpenerFunctionName="+getCurTVItem().name+"&SerialNo="+"<%=sSerialNo%>";
	...
	function TreeViewOnClick()
	{
		...
		openChildComp("RetailAttachmentList","/BusinessManage/PosManage/MobilePosApplyFlow/ImageViewFramePos.jsp","ComponentName="+sCurItemName+"&AccountType=ALL&Type="+sCurItemDescribe);
	}
