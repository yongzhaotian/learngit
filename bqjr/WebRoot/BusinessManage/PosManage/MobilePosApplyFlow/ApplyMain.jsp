...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Main02;Describe=定义变量，获取参数;]~*/%>
    ...
    //获得组件参数    :申请类型
    String sApplyType = "MobilePosApply";//这里直接改为写死的ApplyType
...
<%/*~BEGIN~可编辑区[Editable=true;CodeAreaID=Main05;Describe=树图事件;]~*/%>
    ...
    function TreeViewOnClick(){
        ...
        if(sCurItemDescribe1 != "root"){
            AsControl.OpenView(sCurItemDescribe1,"ComponentName=授信申请列表&ApplyType=<%=sApplyType%>&PhaseType="+getCurTVItem().id,"right");
