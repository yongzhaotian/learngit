...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List01;Describe=定义页面属性;]~*/%>
	<%
	String PG_TITLE = "合同查询"; // 浏览器窗口标题 <title> PG_TITLE </title>
	String PG_CONTENT_TITLE = "&nbsp;&nbsp;合同查询&nbsp;&nbsp;";
	%>
<%/*~END~*/%>
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List04;Describe=定义按钮;]~*/%>
	...
	String sButtons[][] = {
		...
		//{"true","","Button","代扣账号变更","代扣账号变更","",sResourcesPath},
		//{"true","","Button","发起再次代扣","发起再次代扣","",sResourcesPath},
		{"true","","Button","提前还款查询","查询提前还款信息","SelectPrepayment()",sResourcesPath},
		//{"true","","Button","退款查询","查询退款查询信息","",sResourcesPath},
		{"true","","Button","退款","退款申请","returnAmtApply()",sResourcesPath},
		...
		//{"true","","Button","确认申请提前还款","确认申请提前还款","affirm('0055','提前还款')",sResourcesPath},
		...
		{"true","","Button","退货","退货申请","returnLoan()",sResourcesPath},
		{"true","","Button","费用减免","费用减免申请","feeWaive()",sResourcesPath},
		{"true","","Button","新增事件","新增事件费用","newFeeEvent()",sResourcesPath},
		//{"true","","Button","保险取消申请","保险取消申请","",sResourcesPath},
		//{"true","","Button","保险金申请","保险金申请","",sResourcesPath},
		//{"true","","Button","电子合同调阅","电子合同调阅","",sResourcesPath},
		//{"true","","Button","影像合同调阅","影像合同调阅","",sResourcesPath},
	};
	%> 
<%/*~END~*/%>
