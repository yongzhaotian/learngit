...
<%	
	...
	String sTempletNo = "HomeManageList"; //模版编号
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List04;Describe=定义按钮;]~*/%>
	...
	String sButtons[][] = {
		   {"true","","Button","查询家访要求","查询家访要求","viewVisit()",sResourcesPath},
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	{ 	 
		...
		sCompID = "HomeManagerInfo";
		sCompURL = "/BusinessManage/QueryManage/HomeManagerInfo.jsp";
	...
	/*~[Describe=查询家访要求;InputParam=无;OutPutParam=无;]~*/
	function viewVisit(){
		sSerialNo = getItemValue(0,getRow(),"ApplySerialNo");//合同申请编号
		...
		sCompID = "HomeVisitInfo";
		sCompURL = "/InfoManage/QuickSearch/HomeVisitInfo.jsp";
		sParamString ="SerialNo="+sSerialNo+"&Flag="+"Y";
		sReturn = popComp(sCompID,sCompURL,sParamString,"dialogWidth=500px;dialogHeight=450px;resizable=no;scrollbars=no;status:yes;maximize:no;help:no;");
	    reloadSelf();
	}
	...
	function viewHomeStatus()
	{
		...
		sCompID = "HomeStatusInfo";
		sCompURL = "/BusinessManage/QueryManage/HomeStatusInfo.jsp";
		sParamString ="SerialNo="+sSerialNo;
		sReturn = popComp(sCompID,sCompURL,sParamString,"dialogWidth=500px;dialogHeight=450px;resizable=no;scrollbars=no;status:yes;maximize:no;help:no;");
		reloadSelf();
	}
