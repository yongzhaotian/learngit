...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Info01;Describe=定义页面属性;]~*/%>
	<%
	String PG_TITLE = "现金贷款客户清单设置"; // 浏览器窗口标题 <title> PG_TITLE </title>
	%>
<%/*~END~*/%>
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Info03;Describe=定义数据对象;]~*/%>
	...
	//定义变量
		...
		//获得页面参数
    	String sSerialNo = DataConvert.toRealString(iPostChange,(String)CurPage.getParameter("DetailedNo"));
    	if(sSerialNo==null) sSerialNo="";
		
		// 通过DW模型产生ASDataObject对象doTemp
		String sTempletNo = "DetailedManageInfo";//模型编号
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=Info06;Describe=定义按钮事件;]~*/%>
	...
	function goBack(){
		OpenPage("/BusinessManage/QueryManage/DetailedManageList.jsp","_self","");
	}	
	</script>
<%/*~END~*/%>
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=Info07;Describe=自定义函数;]~*/%>
	...
	function pageReload(){
		sSerialNo = getItemValue(0,getRow(),"DetailedNo");//--重新获得流水号
		OpenPage("/BusinessManage/QueryManage/DetailedManageInfo.jsp?DetailedNo="+sSerialNo+"", "_self","");
	}
	...
	function initSerialNo(){
		var sTableName = "Detaile_List";//表名
		var sColumnName = "DetailedNo";//字段名
		var sPrefix = "";//前缀
