<%@ page contentType="text/html; charset=GBK"%><%@
 include file="/IncludeBegin.jsp"%><%
	...
	tviTemp.insertPage("root","门店信息","",1);
	tviTemp.insertPage("root","零售商信息","",2);
...
<script type="text/javascript"> 
	...
	function TreeViewOnClick(){
		...
		}else if(sCurItemname=="零售商信息"){
			//openChildComp("/BusinessManage/ChannelManage/RetailApplyInfoForStore.jsp","");
			openChildComp("/BusinessManage/ChannelManage/RetailApplyInfo.jsp","RSSerialNo=<%=sRSSerialNo %>&RSerialNo=<%=sRSerialNo%>&ViewId=02&ApplyType=<%=sApplyType%>");
		}
