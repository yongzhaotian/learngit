<%@ page contentType="text/html; charset=GBK"%><%@
 include file="/IncludeBegin.jsp"%><%
	...
	String sTempletNo = "RetailStoreTaskList";//模型编号
	...
	String sButtons[][] = {
		{"false","","Button","确定","新增一条记录","newRecord()",sResourcesPath},
		{"true","","Button","确定","确定","viewAndEdit()",sResourcesPath},
		{"true","","Button","返回","返回","deleteRecord()",sResourcesPath},
