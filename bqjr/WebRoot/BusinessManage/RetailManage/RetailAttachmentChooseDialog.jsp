...
<%
	...
	ARE.getLog().debug("参数：sType="+sType+",sObjectNo="+sObjectNo+",isNtfs="+isNtfs);
%>
<html>
<head> 
<title>请输入附件信息</title>
...
<body bgcolor="#D3D3D3">
<form name="SelectAttachment" method="post" ENCTYPE="multipart/form-data" action="<%=sWebRootPath%>/BusinessManage/RetailManage/RetailAttachmentUpload.jsp?CompClientID=<%=CurComp.getClientID()%>" align="center">
<table align="center">
	<tr>
