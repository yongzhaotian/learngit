...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=View02;Describe=定义变量，获取参数;]~*/%>
	...
	String sTreeViewTemplet = "StoreApplyFileView";//
...
<%/*~BEGIN~可编辑区[Editable=true;CodeAreaID=View05;]~*/%>
	...
	function TreeViewOnClick()
	{
		...
		openChildComp("StoreAttachmentList","/BusinessManage/RetailManage/ImageViewFrameS.jsp","ComponentName="+sCurItemName+"&AccountType=ALL&Type="+sCurItemDescribe+"&RegCode=<%=sRegCode%>&PhaseType=<%=sPhaseType%>");
	}
