<%@ page contentType="text/html; charset=GBK"%><%@
 include file="/IncludeBegin.jsp"%><%
	...
	tviTemp.insertPage("root","审批中的申请","",2);
	tviTemp.insertPage("root","审批通过的申请","",3);
	tviTemp.insertPage("root","被拒绝的申请","",3);
...
<script type="text/javascript"> 
	...
	function initTreeView(){
		...
		expandNode('root');
		selectItemByName("待处理的申请");	//默认打开的(叶子)选项	
	}
