<%@ page contentType="text/html; charset=GBK"%><%@
 include file="/IncludeBegin.jsp"%><%
	/*
		页面说明:示例模块主页面
	 */
	String PG_TITLE = "零售商管理"; // 浏览器窗口标题 <title> PG_TITLE </title>
	...
	tviTemp.insertPage("root","零售商列表","",1);
...
<script type="text/javascript"> 
	...
	function TreeViewOnClick(){
		...
		if(sCurItemname=='零售商列表'){
			AsControl.OpenView("/BusinessManage/RetailManage/RetailList.jsp","Modify=N","right");
		}else{
			return;
		}
	...
	function initTreeView(){
		...
		expandNode('root');
		selectItem(1);
		selectItemByName("零售商列表");	//默认打开的(叶子)选项	
	}
