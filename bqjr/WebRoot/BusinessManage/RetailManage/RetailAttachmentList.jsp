...
<%
	...
	String company = Sqlca.getString(new SqlObject("select r.company from retail_info r where r.SerialNo=:serialNo").setParameter("serialNo", sSerialNo));
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	function newRecord()
	{
		...
		var company = "<%=company%>";
		popComp("AttachmentChooseDialog","/BusinessManage/RetailManage/RetailAttachmentChooseDialog.jsp","Type="+sType+"&ObjectNo="+sObjectNo+"&isNtfs=Y&company="+company+"","dialogWidth=650px;dialogHeight=250px;resizable=no;scrollbars=no;status:yes;maximize:no;help:no;");
		reloadSelf();
	}
	...
	function viewFile()
	{
		...
		{
			popComp("AttachmentView","/BusinessManage/RetailManage/AttachmentViewRetail.jsp","DocNo="+sDocNo+"&AttachmentNo="+sAttachmentNo);
		}
	}
	...
	function DownAllFile(){
		...
		popComp("AttachmentView","/BusinessManage/RetailManage/DownAllFile.jsp","SerialNo="+sObjectNo+"&Type="+sType+"&Ntfs=R");
