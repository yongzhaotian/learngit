<%@ page contentType="text/html; charset=GBK"%><%@
 include file="/IncludeBegin.jsp"%><%
	/*
		页面说明: 示例列表页面
	 */
	String PG_TITLE = "门店待邮寄包裹";
	//获得页面参数
	//String sInputUser =  DataConvert.toRealString(iPostChange,(String)CurPage.getParameter("InputUser"));

	
	//通过DW模型产生ASDataObject对象doTemp
	String sTempletNo = "ShopPackageList";//模型编号
	ASDataObject doTemp = new ASDataObject(sTempletNo,Sqlca);
	//CCS-885 修改包裹管理，登录人员只能查询自己的信息 update huzp 20150702
	doTemp.WhereClause = " WHERE status='01' and packtype='01' and CreateUser='"+CurUser.getUserID()+"'";
...
<script type="text/javascript">
	...
	function confirmPost(){
		...
		if(sCreateUser == userid){
			...
			//更新包裹关联的合同地标状态由门店变更为"送往总部"(1:门店；2：送往总部；3：送往贷款人；4：贷款人)
	...
	function printPostList(){
		...
		if(sCreateUser == userid){//如果登陆人与包裹创建人相同，可以操作
	...
	function relativeContract(){
		...
		sString="PackNo="+sPackNo+"&Flag="+"Y"+"&CreateUser="+sCreateUser+"&SNo="+SNo;
	...
	<%/*~[Describe=新增包裹信息;InputParam=无;OutPutParam=无;] ~*/%>
	function newRecord(){
