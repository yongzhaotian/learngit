...
<%
	...
	doTemp.WhereClause = " WHERE (qg.QUALITYGRADE = '1' or (qg.QUALITYGRADE = '2' AND ceil((to_date('"+curDateTime+"','yyyy-mm-dd hh24-mi-ss') - To_date(inputtime, 'yyyy-mm-dd hh24-mi-ss'))) < 4)) AND ceil((to_date('"+curDateTime+"','yyyy-mm-dd hh24-mi-ss') - To_date(inputtime, 'yyyy-mm-dd hh24-mi-ss'))) > 1 AND bc.SERIALNO=qg.ARTIFICIALNO AND bc.SALESEXECUTIVE='"+sCurUser+"' ";                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      
