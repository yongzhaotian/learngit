...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=View02;Describe=定义变量，获取参数;]~*/%>
	...
	//获得组件参数	
	String sWizardNo = DataConvert.toRealString(iPostChange,(String)CurComp.getParameter("ObjectNo"));
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=View03;Describe=定义树图;]~*/%>
	...
	//定义树图结构
	String sSqlTreeView = "from CODE_LIBRARY where CodeNo='WizardDefView' and IsInUse='1' ";
...
<%/*~BEGIN~可编辑区[Editable=true;CodeAreaID=View05;]~*/%>
	...
	function TreeViewOnClick()
	{
		...
		if(sCurItemID=="0010")
		{
            openChildComp("WizardDefInfo","/Common/Configurator/WizardManage/WizardDefInfo.jsp","WizardNo=<%=sWizardNo%>");
			
		}else if(sCurItemID=="0020")
		{
			openChildComp("PhaseDefList","/Common/Configurator/WizardManage/PhaseDefList.jsp","WizardNo=<%=sWizardNo%>");
