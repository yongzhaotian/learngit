...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List01;Describe=定义页面属性;]~*/%>
	<%
	String PG_TITLE = "组件输出参数详情"; // 浏览器窗口标题 <title> PG_TITLE </title>
	%>
<%/*~END~*/%>
...
<%	
	...
	sSql = "select "+
		   ...
		   "ParameterName,"+
		   "CalculateScript "+
		  "from WZD_PHASE_OUTPUT Where WizardNo = '"+sWizardNo+"' and PhaseNo = '"+sPhaseNo+"' and ParameterID = '"+sParameterID+"'";
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	function newRecord()
	{
        ...
        OpenComp("PhaseOutputInfo","/Common/Configurator/WizardManage/PhaseOutputInfo.jsp","WizardNo="+sWizardNo+"&PhaseNo="+sPhaseNo+"&IsNew=Y","_self",""); 
        //OpenPage("/Common/Configurator/WizardManage/PhaseOutputInfo.jsp?WizardNo="+sWizardNo+"&PhaseNo="+sPhaseNo,"_self","");
	}
	</script>
<%/*~END~*/%>
