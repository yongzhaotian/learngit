<%@ page contentType="text/html; charset=GBK"%><%@
 include file="/IncludeBegin.jsp"%><%
	/*
		Content:    决策流模型目录视图
	 */
	String PG_TITLE = "决策流模型目录视图"; // 浏览器窗口标题 <title> PG_TITLE </title>
	String PG_CONTENT_TITLE = "&nbsp;&nbsp;决策流模型目录视图&nbsp;&nbsp;"; //默认的内容区标题
	...
	//定义Treeview
	HTMLTreeView tviTemp = new HTMLTreeView(SqlcaRepository,CurComp,sServletURL,"决策流模型","right");
	...
	sSqlTreeView += "and (RelativeCode like '%"+sViewID+"%' or trim(RelativeCode) ='All') ";//视图filter Add by zhuang 2010-03-17
