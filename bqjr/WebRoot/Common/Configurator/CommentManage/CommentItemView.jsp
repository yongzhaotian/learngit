...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=View02;Describe=定义变量，获取参数;]~*/%>
	...
	//获得组件参数	
	String sCommentItemID = DataConvert.toRealString(iPostChange,(String)CurComp.getParameter("ObjectNo"));
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=View03;Describe=定义树图;]~*/%>
	...
	//定义树图结构
	String sSqlTreeView = "from CODE_LIBRARY where CodeNo='CommentItemView' and IsInUse='1' ";
...
<%/*~BEGIN~可编辑区[Editable=true;CodeAreaID=View05;]~*/%>
	...
	function TreeViewOnClick()
	{
		...
		if(sCurItemID=="0010")
		{
            openChildComp("CommentItemInfo","/Common/Configurator/CommentManage/CommentItemInfo.jsp","CommentItemID=<%=sCommentItemID%>");
			
		}else if(sCurItemID=="0020")
		{
			openChildComp("CommentRelaList","/Common/Configurator/CommentManage/CommentRelaList.jsp","CommentItemID=<%=sCommentItemID%>");
