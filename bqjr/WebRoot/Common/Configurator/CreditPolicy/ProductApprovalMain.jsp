<%@ page contentType="text/html; charset=GBK"%><%@
 include file="/IncludeBegin.jsp"%><%
	/*
		页面说明:示例模块主页面
	 */
	String PG_TITLE = "产品审批"; // 浏览器窗口标题 <title> PG_TITLE </title>
	String PG_CONTENT_TITLE = "&nbsp;&nbsp;产品审批&nbsp;&nbsp;"; //默认的内容区标题
	...
	tviTemp.insertPage("root","未完成审批","",1);
	tviTemp.insertPage("root","已完成审批","",2);
...
<script type="text/javascript"> 
	function TreeViewOnClick(){
		...
		if(sCurItemname=='未完成审批'){
			AsControl.OpenView("","","right");
		}else if(sCurItemname=='已完成审批'){
			AsControl.OpenView("","","right");
		}else{
			return;
		}
