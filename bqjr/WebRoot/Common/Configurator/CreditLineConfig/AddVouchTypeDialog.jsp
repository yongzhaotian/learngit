...
<%
	int num = 0;
	sSql = " select ItemNo || ' ' || ItemName as AllVouch "+
		   " from CODE_LIBRARY "+
		   " where CodeNo = 'VouchType' "+
		   " and ItemNo not in ('"+sCLTeamContentID+"') "+
		   " and IsInUse = '1' "+
		   " and Attribute8 = '1' "+
		   " order by SortNo ";
	...
	sSql1 = " select ItemNo || ' ' || ItemName as AllVouch "+
		    " from CODE_LIBRARY "+
		    " where CodeNo = 'VouchType' "+
		    " and ItemNo in ('"+sCLTeamContentID+"') "+
		    " and IsInUse = '1' "+
		    " and Attribute8 = '1' "+
		    " order by SortNo ";
	...
	<tr>
		<td>
			<table width='100%' border='1' cellpadding='0' cellspacing='5' bgcolor='#DDDDDD'>
				<tr>
					<td colspan="4">
						<span>选取要新增的担保方式</span>
					</td>
				</tr>
				<tr>
					<td bgcolor='#DDDDDD'>
						<span class='dialog-label'>可增加的担保方式列表</span>
					</td>
					<td bordercolor='#DDDDDD'></td>
					<td bgcolor='#DDDDDD'>
						<span class='dialog-label'>待新增的担保方式列表</span>
					</td>
					<td></td>
				</tr>
				<tr>
