...
<%
	             String sTempletNo = "LimitationTypeInfo";
	...
	//生成HTMLDataWindow
	Vector vTemp = dwTemp.genHTMLDataWindow(sTypeID);
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=Info07;Describe=自定义函数;]~*/%>
	...
	function reloadCache(){
    	if(confirm("您已对额度限制类型进行了修改，现在刷新额度限制类型定义缓存吗？")){
    		AsDebug.reloadCache("SYSCONF_LIMITATIONTYPE");
    	}
    }
	...
	function initSerialNo(){
		var sTableName = "CL_LIMITATION_TYPE";//表名
		var sColumnName = "TypeID";//字段名
		var sPrefix = "";//前缀
