...
<%
	int num = 0;
	sSql = " select ItemNo || ' ' || ItemName as AllCurrency "+
		   " from CODE_LIBRARY "+
		   " where CodeNo = 'Currency' "+
	...
	sSql1 = " select ItemNo || ' ' || ItemName as AllCurrency "+
		    " from CODE_LIBRARY "+
		    " where CodeNo = 'Currency' "+
	...
	<tr>
		<td>
			<table width='100%' border='1' cellpadding='0' cellspacing='5' bgcolor='#DDDDDD'>
				...
				<tr>
					<td bgcolor='#DDDDDD'>
						<span class='dialog-label'>可新增的币种列表</span>
					</td>
					<td bordercolor='#DDDDDD'></td>
					<td bgcolor='#DDDDDD'>
						<span class='dialog-label'>待新增的币种列表</span>
					</td>
					<td></td>
				</tr>
				<tr>
