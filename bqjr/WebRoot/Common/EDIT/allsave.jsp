...
<%
	...
	if(sMethod.equals("2")) //save
	{
        ...
        pre1.setBinaryStream(1, new java.io.ByteArrayInputStream(abyte1,0,abyte1.length), abyte1.length);
        ...
        pre2.setBinaryStream(1, new java.io.ByteArrayInputStream(abyte2,0,abyte2.length), abyte2.length);
