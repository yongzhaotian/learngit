...
<script type="text/javascript">	
	...
	AsControl.OpenView("/Common/WorkFlow/SignTaskImageInfo.jsp","ObjectType=<%=sObjectType%>&ObjectNo=<%=sObjectNo%>&FlowNo=<%=sFlowNo%>&PhaseNo=<%=sPhaseNo%>","frameleft",OpenStyle);
	AsControl.OpenView("/Common/WorkFlow/SignTaskCreditInfo.jsp","ObjectType=<%=sObjectType%>&ObjectNo=<%=sObjectNo%>&FlowNo=<%=sFlowNo%>&PhaseNo=<%=sPhaseNo%>","frameright",OpenStyle);
</script>	
