...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List03;Describe=定义数据对象;]~*/%>
	...
	if(sFinishFlag.equals("N")) //当前工作
	    ...
	    if(sButton==null)sButton="viewTab,viewReport,viewOpinions,signCheckOpinion,riskSkan,doSubmit,backStep,backStart";
	if(sFinishFlag.equals("Y")) //已完成工作
    	...
    	if(sButton==null)sButton="viewTab,viewReport,viewOpinions,riskSkan,viewFlow";
	//将空值转化成空字符串
	if(sButton == null) sButton = "";
			
	//通过显示模版产生ASDataObject对象doTemp
	String sTempletFilter = "1=1";
	//System.out.println("----"+sTempletNo);
