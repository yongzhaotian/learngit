...
//			sPhaseInfo = RunJavaMethodSqlca("com.amarsoft.biz.workflow.action.FlowAction","AutoCommit","SerialNo="+sSerialNo+",objectType="+sObjectType+",objectNo="+sObjectNo+",oldPhaseNo="+sPhaseNo+",userID="+sUserID);
		...
		if(typeof(sPhaseInfo)=="undefined" || sPhaseInfo=="" || sPhaseInfo==null || sPhaseInfo=="null" || sPhaseInfo=="_CANCEL_")  	{alert(8);return;}
		else if (sPhaseInfo == "Success"){
			RunMethod("ModifyNumber","GetModifyNumber","business_contract,ContractStatus='210',serialNo='"+sObjectNo+"'");//修改合同状态
			alert(getHtmlMessage('18'));//提交成功！	
			//刷新件数及页面
			parent.reloadSelf();
//		OpenComp("PutOutAppoveApplyMain","/Common/WorkFlow/PutOutApply/PutOutAppoveApplyMain.jsp","ComponentType=MainWindow&ApproveType=<%=sApproveType%>","_top","");
