...
<%	
	...
	ARE.getLog().debug(""+sSerialNo+","+sObjectNo+","+sObjectType+","+sFlowNo);
%>
<%/*~END~*/%>
	...
	<%
	   ...
	   // 通过DW模型产生ASDataObject对象doTemp
		String sTempletNo = "CarSignTaskOpinionInfo";//模型编号
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Info04;Describe=定义按钮;]~*/%>
	...
	String sButtons[][] = {
			...
			{"false","","Button","电话仓库","电话仓库","getPhoneCode()",sResourcesPath},
		};
