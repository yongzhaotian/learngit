...
<script type="text/javascript">	
	...
	AsControl.OpenView("Common/WorkFlow/SignTaskOpinionInfoViewLR.jsp","SerialNo=<%=sObjectNo%>&TaskNo=<%=sSerialNo%>","rightup",OpenStyle);
	// edit by xswang 20150505 CCS-637 PRM-293 审核过程中审核要点功能维护
	/* AsControl.OpenView("/Common/WorkFlow/SignTaskOpinionInfoNew.jsp","","rightdown",OpenStyle); */
	AsControl.OpenView("/Common/WorkFlow/SignTaskOpinionInfoViewRR.jsp","","rightdown",OpenStyle);
