...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Info04;Describe=定义按钮;]~*/%>
	<%
		...
		String s5[]={"true","","Button","存量咨询","存量咨询","realLoanSimulation()",sResourcesPath};
...
<script type="text/javascript">
	...
	String sTabStrip[][] = {
		...
		{"","分户帐信息","doTabAction(\'"+BUSINESSOBJECT_CONSTATNTS.subsidiary_ledger+"@SubsidiaryledgerList\')"},
	...
	function doTabAction(tabaction){
		if(tabaction=="Loan"){
			OpenComp("ACCT_LoanSimulationBasicInfo","/Accounting/LoanSimulation/LoanBasicInfo_Mic.jsp","","<%=sIframeName%>");
		}
