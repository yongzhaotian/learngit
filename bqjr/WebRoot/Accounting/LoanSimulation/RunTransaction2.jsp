...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Main02;Describe=定义变量，获取参数;]~*/%>
	...
	if(transactionSerialNo!=null&&transactionSerialNo.length()>0){
		...
		transaction = TransactionFunctions.createTransaction(transactionCode, documentObject, relativeObject, "", transactionDate,bom);
	...
	if(BUSINESSOBJECT_CONSTATNTS.business_contract.equals(documentType)){
