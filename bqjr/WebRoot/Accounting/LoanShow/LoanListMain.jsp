<%@ page contentType="text/html; charset=GBK"%><%@
 include file="/IncludeBegin.jsp"%><%
	/*
		页面说明:示例模块主页面
	 */
	String PG_TITLE = "贷款台账"; // 浏览器窗口标题 <title> PG_TITLE </title>
	...
	tviTemp.insertPage(sFolder1,"贷款台账","",1);
...
<script type="text/javascript"> 
	function TreeViewOnClick(){
		...
		if(sCurItemname=='贷款台账'){
			AsControl.OpenView("/Accounting/LoanShow/LoanList.jsp","","right");
	...
	function initTreeView(){
		...
		expandNode('root');
		selectItemByName("贷款台账");	//默认打开的(叶子)选项	
	}
