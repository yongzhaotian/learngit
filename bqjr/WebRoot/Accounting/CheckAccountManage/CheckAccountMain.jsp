<%@ page contentType="text/html; charset=GBK"%><%@
 include file="/IncludeBegin.jsp"%><%
	/*
		页面说明:示例模块主页面
	 */
	String PG_TITLE = "对账管理主页面"; // 浏览器窗口标题 <title> PG_TITLE </title>
	String PG_CONTENT_TITLE = "&nbsp;&nbsp;对账管理主页面&nbsp;&nbsp;"; //默认的内容区标题
	String PG_CONTNET_TEXT = "请点击左侧列表";//默认的内容区文字
	String PG_LEFT_WIDTH = "2";//默认的treeview宽度
	...
	tviTemp.insertPage(sFolder1,"对账管理","",1);
...
<script type="text/javascript"> 
	function TreeViewOnClick(){
		...
		if(sCurItemname=='对账管理'){
			AsControl.OpenView("/SystemManage/SynthesisManage/DzTab.jsp","","right");
	...
	function initTreeView(){
		...
		expandNode('root');
		selectItemByName("对账管理");	//默认打开的(叶子)选项	
	}
