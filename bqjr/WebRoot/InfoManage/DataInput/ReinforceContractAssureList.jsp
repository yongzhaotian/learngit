...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List00;Describe=注释区;]~*/%>
	...
	/*
		...
		Tester:
		Describe: 业务合同补登所对应的新增的担保合同列表（一个保证合同对应一个保证人）;
		Input Param:
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List04;Describe=定义按钮;]~*/%>
	...
	String sButtons[][] = {
		...
		{("020".equals(sContractType)?"true":"false"),"","Button","引入","新增担保信息","importGuaranty()",sResourcesPath},
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	//增加“引入”按钮，实现最高额担保合同的引入 yxzhang@2010/04/08
