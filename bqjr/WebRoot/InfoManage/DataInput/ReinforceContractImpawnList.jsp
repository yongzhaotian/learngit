...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List00;Describe=注释区;]~*/%>
	...
	/*
		...
		Tester:
		Describe: 业务合同补登新增的担保合同所对应的质物信息列表;
		Input Param:
			ObjectType：对象类型
			ObjectNo: 对象编号
			ContractNo：担保信息编号
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List04;Describe=定义按钮;]~*/%>
	...
	String sButtons[][] = {
		{"true","","Button","新增","新增质物信息","newRecord()",sResourcesPath},
		{"true","","Button","引入","引入已经登记的质物信息","importGuaranty()",sResourcesPath},
		{"true","","Button","详情","查看质物信息详情","viewAndEdit()",sResourcesPath},
		{"true","","Button","删除","删除质物信息","deleteRecord()",sResourcesPath}
	};
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	function newRecord()
	{
		...
		OpenPage("/InfoManage/DataInput/ReinforceContractImpawnInfo.jsp?ObjectType=<%=sObjectType%>&ObjectNo=<%=sObjectNo%>&ContractNo=<%=sContractNo%>&ImpawnType="+sImpawnType,"_self");
	}
	...
	function viewAndEdit()
	{
		...
		{
			OpenPage("/InfoManage/DataInput/ReinforceContractImpawnInfo.jsp?ObjectType=<%=sObjectType%>&ObjectNo=<%=sObjectNo%>&ContractNo=<%=sContractNo%>&GuarantyID="+sGuarantyID+"&ImpawnType="+sImpawnType,"_self");
		}
	}
