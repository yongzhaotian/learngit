...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=View01;Describe=定义页面属性;]~*/%>
	<%
	String PG_TITLE = "补登授信额度详情"; // 浏览器窗口标题 <title> PG_TITLE </title>
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=View03;Describe=定义树图;]~*/%>
	...
	sCreditLineID = Sqlca.getString(new SqlObject(sSql).setParameter("BCSerialNo",sObjectNo));
	//定义Treeview
	...
	String sSqlTreeView = "from CODE_LIBRARY where CodeNo= 'ReinforceCreditLineView' and RelativeCode like '%"+sObjectType+"%' and Attribute1 like '%"+sBusinessType+"%' and IsInUse = '1' ";
