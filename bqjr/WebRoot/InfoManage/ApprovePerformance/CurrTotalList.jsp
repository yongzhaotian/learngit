...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List01;Describe=定义页面属性;]~*/%>
	<%
	String PG_TITLE = "目前累计审批绩效查询"; // 浏览器窗口标题 <title> PG_TITLE </title>
	String PG_CONTENT_TITLE = "&nbsp;&nbsp;目前累计审批绩效查询&nbsp;&nbsp;";
	%>
<%/*~END~*/%>
...
<%	
	...
	String sHeaders[][] = { 							
							...
							{"OrgName","审批人所属机构"},
							{"UserName","审批人姓名"},
							{"CApplySum","目前累计申请总金额（元）"},
							{"CurrDealCount","目前待审批笔数"},
							{"CurrDealSum","目前待审批金额（元）"},
							{"CAggreeCount","目前累计批准总笔数"},
							{"CDisagreeCount","目前累计否决总笔数"},
							{"CAfloatCount","目前累计在途总笔数"},
							{"CAggreeTime","目前累计批准总耗时（天）"},										
							{"CDisagreeTime","目前累计否决总耗时（天）"},
							{"CAfloatTime","目前累计在途总耗时（天）"},
							{"CNApproveCount","目前累计未签批复总笔数"},
							{"CNApproveSum","目前累计未签批复总金额（元）"},
							{"CNContractCount","目前累计未签合同总笔数"},
							{"CNContractSum","目前累计未签合同总金额（元）"},
							{"CNPutoutCount","目前累计未放贷总笔数"},
							{"CNPutoutSum","目前累计未放贷总金额（元）"},
							{"CNormalSum","目前累计正常总余额（元）"},
							{"CAttentionSum","目前累计关注总余额（元）"},
							{"CSecondarySum","目前累计次级总余额（元）"},
							{"CShadinessSum","目前累计可疑总余额（元）"},
							{"CLossSum","目前累计损失总余额（元）"}
						   }; 
