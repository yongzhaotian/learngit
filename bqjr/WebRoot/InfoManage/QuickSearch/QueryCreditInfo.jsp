...
<%	
   ...
   //客户主管    add by ybpan at 20150409 CCS-588  系统中增加中域ALDI模式的客户主管
	...
	if(sOccurType.equals("015")){
		...
		if(sObjectType.equals("BusinessContract") || sObjectType.equals("QueryBusinessContract") || sObjectType.equals("AfterLoan") || sObjectType.equals("ReinforceContract")) //合同对象
...
<%
   ...
   //end
   RoleAuthController rac = new RoleAuthController(doTemp, CurUser.getRoleTable(), "QueryCreditInfo", Sqlca, "01");
	...
	{	
		...
		if(ShoufuRatioType=="1"){
			...
			if(parseFloat(sTotalSum) == parseFloat(ShoufuRatio)){
				...
				alert("首付金额必须等于产品首付金额："+ShoufuRatio+"%");
				return false;
			}
