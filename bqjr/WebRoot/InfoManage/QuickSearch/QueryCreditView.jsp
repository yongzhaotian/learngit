...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=View03;Describe=定义树图;]~*/%>
	...
	if(CurUser.hasRole("1801")){//还款专员角色才能执行以下操作 2015、06、11修改
 	...
 	//}else{
 	//	sSqlTreeView += " and PRD_NODECONFIG.NodeID <> '8006'";
 	//}
 	RoleAuthController rac = new RoleAuthController(CurUser.getRoleTable(), "QueryCreditView", Sqlca, "01");
	sSqlTreeView = rac.roleTreeViewAuth(sSqlTreeView);
