...
<%	
	...
	doTemp.setFilter(Sqlca, "0030", "CustomerName", "Operators=EqualsString;");
	...
	//添加提单时间作为查询条件CCS-776
	doTemp.setFilter(Sqlca, "003313", "SALESUBMITTIME", "Operators=BetweenString,BeginsWith;");
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List04;Describe=定义按钮;]~*/%>
	...
	String sButtons[][] = {
			...
			//add by huanghui CCS-1115 PRM-656 快速合同查询的功能限制
