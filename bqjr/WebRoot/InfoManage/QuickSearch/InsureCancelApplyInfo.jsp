...
<%@ include file="/IncludeBegin.jsp"%>
	...
	String sTempletNo = "InsureCancelApplyInfo";//模型编号
	...
	String sButtons[][] = {
		{"true","","Button","保险取消","保险取消","saveRecord()",sResourcesPath}
	};
	%> 
	...
	{	
		if (getRowCount(0)==0) //如果没有找到对应记录，则新增一条，并设置字段默认值
		{
			...
			//流水号
			initSerialNo();
			//申请类型（ApplicationType:保险取消申请：03）
			setItemValue(0,0,"ApplicationType","03");
			//处理状态
