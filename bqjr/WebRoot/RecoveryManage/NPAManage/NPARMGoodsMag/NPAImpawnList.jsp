<%@ page contentType="text/html; charset=GBK"%><%@
 include file="/IncludeBegin.jsp"%><%
	...
	String sTempletNo = "NPAImpawnList";//模型编号
	...
	String sButtons[][] = {			
			{"true","","Button","详情","查看抵质物信息详情","viewAndEdit()",sResourcesPath},
			{"true","","Button","价值变更","抵质物价值变更","valueChange()",sResourcesPath},
			{"true","","Button","其他信息变更","抵质物其他信息变更","otherChange()",sResourcesPath},
...
{		
	OpenPage("/RecoveryManage/NPAManage/NPARMGoodsMag/NPAImpawnInfo.jsp?GuarantyID="+sGuarantyID+"&ImpawnType="+sGuarantyType,"_self");
}
}



/*~[Describe=抵质物价值变更;InputParam=无;OutPutParam=无;]~*/
...
/*~[Describe=抵质物其他信息变更;InputParam=无;OutPutParam=无;]~*/
