...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=List04;Describe=定义按钮;]~*/%>
	...
	String sButtons[][] = {
				{sFinishType.equals("")?"true":"false","","Button","新增","新增抵质押物信息变更","newRecord()",sResourcesPath},
				{"true","","Button","详情","查看抵质押物信息变更详情","viewAndEdit()",sResourcesPath},
				{sFinishType.equals("")?"true":"false","","Button","删除","删除抵质押物信息变更","deleteRecord()",sResourcesPath}
			};			
	%>
<%/*~END~*/%>
