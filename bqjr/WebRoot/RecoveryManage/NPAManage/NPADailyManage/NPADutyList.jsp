<%@ page contentType="text/html; charset=GBK"%><%@
 include file="/IncludeBegin.jsp"%><%
	...
	String sTempletNo = "NPADutyList";//模型编号
	...
	String sButtons[][] = {
			{sFinishType.equals("")?"true":"false","","Button","新增","新增责任认定信息","newRecord()",sResourcesPath},
			{"true","","Button","详情","查看责任认定信息","viewAndEdit()",sResourcesPath},
			{sFinishType.equals("")?"true":"false","","Button","删除","删除责任认定信息","deleteRecord()",sResourcesPath},
			};
		%>
	<%/*~END~*/%>
