<%@ page contentType="text/html; charset=GBK"%><%@
 include file="/IncludeBegin.jsp"%><%
	...
	String sTempletNo = "PDAClassifyList";//模型编号
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=List06;Describe=自定义函数;]~*/%>
	...
	function viewAndEdit()
	{
		...
		{
			OpenPage("/RecoveryManage/PDAManage/PDADailyManage/PDAClassifyInfo.jsp?SerialNo="+sSerialNo+"AssetStatus="+sAssetStatus,"right","");
		}
	}	
	</script>
<%/*~END~*/%>
