...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Info04;Describe=定义按钮;]~*/%>
	...
	//依次为：
		...
		//6.资源图片路径
	String sButtons[][] = {
			{"true","","Button","确认","确认新增重组方案","doCreation()",sResourcesPath},
			{"true","","Button","取消","取消新增重组方案","doCancel()",sResourcesPath},
	};
	%> 
<%/*~END~*/%>
...
<%/*~BEGIN~可编辑区~[Editable=false;CodeAreaID=Info07;Describe=自定义函数;]~*/%>
	...
	/*~[Describe=将重组方案流水号返回，并关闭新增窗口;InputParam=无;OutPutParam=无;]~*/
	function doReturn()
	{
		//重组方案流水号		
	...
	/*~[Describe=取消新增记录操作，并关闭新增窗口;InputParam=无;OutPutParam=无;]~*/
	function doCancel(){		
	...
	function initRow()
	{
		if (getRowCount(0)==0) //如果没有找到对应记录，则新增一条，并设置字段默认值
		{
			...
			bIsInsert = true;			
			setItemValue(0,0,"BusinessType","6010");		
			setItemValue(0,0,"OperateOrgID","<%=CurOrg.getOrgID()%>");
			setItemValue(0,0,"TempSaveFlag","01");		
