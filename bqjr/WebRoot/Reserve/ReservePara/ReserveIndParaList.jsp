...
<%	
	...
	String sSql = " select"+
			 	  " AccountMonth,"+
				  " AssetsType,getItemName('CustomerType',AssetsType) as CustomerTypeName,"+
			 	  " RateofLoss,AdjustModulus "+
			 	  " from RESERVE_INDPARA"+
				  " where AssetsType = '"+sCustomerType+"'";
				
	ASDataObject doTemp = new ASDataObject(sSql);
	doTemp.setHeader(sHeaders);	
	doTemp.setVisible("AssetsType",false);
	doTemp.UpdateTable = "RESERVE_INDPARA";
	doTemp.setKey("AccountMonth,AssetsType",true);

	doTemp.setType("RateofLoss,AdjustModulus","Number");
	doTemp.setCheckFormat("RateofLoss,AdjustModulus","2");
	
	//过滤器	
	doTemp.setColumnAttribute("AccountMonth","IsFilter","1");	 */
	
	String sTempletNo = "ReserveIndParaList";
...
<script type="text/javascript">
	...
	{   var sCurrentAccountMonth = "<%=sCurrentAccountMonth%>";
	    ...
	    if (typeof(sReturn) == "undefined" || sReturn == "Refuse") {
	        if (confirm("当期会计月份基础参数信息已存在，您希望查看该信息吗？")) {
	        	OpenPage("/Reserve/ReservePara/ReserveIndParaInfo.jsp","_self","");
	        }
	...
	function viewAndEdit()
	{
		...
		OpenPage("/Reserve/ReservePara/ReserveIndParaInfo.jsp?AccountMonth="+sAccountMonth+"&AssetsType="+sAssetsType,"_self","");
	}
