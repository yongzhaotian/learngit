...
<%
    ...
    String PG_TITLE = "组合计提数据信息维护"; 
    //默认的内容区标题
    String PG_CONTENT_TITLE = "&nbsp;&nbsp;组合计提数据信息维护&nbsp;&nbsp;"; 
    //默认的内容区文字
...
<%
    //定义Treeview
    HTMLTreeView tviTemp = new HTMLTreeView(SqlcaRepository,CurComp,sServletURL,"组合计提数据信息","right");
    //设置资源文件目录（图片、CSS）
    ...
    //定义树图结构
    tviTemp.insertPage("root","公司客户组合计提数据","javascript:top.openPhase('01')",iLeaf++);
    tviTemp.insertPage("root","个人客户组合计提数据","javascript:top.openPhase('03')",iLeaf++);   
%>
<%/*~END~*/%>
