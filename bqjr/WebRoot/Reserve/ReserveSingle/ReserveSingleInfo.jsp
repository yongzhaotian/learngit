...
<%
	...
	String sTempletNo = "ReserveSingleInfo";
	...
	//显示小数点后6位
	doTemp.setCheckFormat("ContractRate","16");
	doTemp.setCheckFormat("AuditRate","16");
...
<script type="text/javascript">
	...
	function goBack()
	{
		OpenPage("/Reserve/ReserveSingle/ReserveSingleList.jsp","_self","");
	}
</script>
<%/*~END~*/%>
