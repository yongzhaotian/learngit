...
// 	if(tableType==null) tableType="";
	...
	String sTempletNo = "TableInfo";//模型编号
	...
	//生成HTMLDataWindow
	Vector vTemp = dwTemp.genHTMLDataWindow(tableNo);//传入参数,逗号分割
...
<script type="text/javascript">
	...
	function goBack(){
		AsControl.OpenView("/SystemManage/DataDictionaryManage/DataDictionaryTableList.jsp","","_self");
	}
