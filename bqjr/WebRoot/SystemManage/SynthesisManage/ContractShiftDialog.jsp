 ...
 * Tester:
 *
 * Content: 获取合同转移更新信息类型
 * Input Param:
 *      	
 * Output param:
 *			
 * History Log:wqchen  2010-03-24 从配置文件获取ApproveNeed的值，判断是否显示合同转移中更新信息类型最终审批意见
 *
 */
%>
	    	...
	    	<td>
				<form name="Condition">
					<table align="center">
						...
						<tr align="center">
							<td align="center"><input type=checkbox name ="chkbox1" value="false" class=changeColor onClick="javascript:setChecked1(this.checked)"></td>
