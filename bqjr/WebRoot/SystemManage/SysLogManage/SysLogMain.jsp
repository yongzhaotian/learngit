...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Main01;Describe=定义页面属性;]~*/%>
	<%
	String PG_TITLE = "系统日志管理主界面"; // 浏览器窗口标题 <title> PG_TITLE </title>
...
<%/*~BEGIN~可编辑区~[Editable=true;CodeAreaID=Main03;Describe=定义树图;]~*/%>
	<%
	//定义Treeview
	HTMLTreeView tviTemp = new HTMLTreeView(SqlcaRepository,CurComp,sServletURL,"系统日志管理查询","right");
	...
	String sSqlTreeView = " from CODE_LIBRARY where CodeNo= 'SysLogManage' and IsInUse = '1' ";
