...
<%
	...
	String sTempletNo = "GrayListUnitAddressInfo";//模型编号
...
<script type="text/javascript">
	...
	function saveRecord(sPostEvents){
		...
		//if (typeof(sVAL)!="undefined" && sVAL.length!=0){
			var sCnt=RunMethod("GrayList_MODEL","checkMulti","GrayListUnitAddress,(PROVINCE||CITY||AREA||TOWN||VILLEGE||CELL||HOUSENO),"+sVAL+","+sSERIALNO);
			if(sCnt>0){
				alert("列表中已有重复的单位地址记录,请重新输入");
	...
	function goBack(){
		AsControl.OpenView("/SystemManage/CustomerFinanceManage/GrayListUnitAddress.jsp","","_self");
	}
