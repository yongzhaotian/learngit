...
<%/*~END~*/%>
 <%
	...
	String sTempletNo = "QualityLableCodeList";//模型编号
...
<script type="text/javascript">
	function newRecord(){
		AsControl.OpenView("/SystemManage/CustomerFinanceManage/QualityLableCodeInfo.jsp","","_self","");
	}
	...
	function viewAndEdit(){
		...
		AsControl.OpenView("/SystemManage/CustomerFinanceManage/QualityLableCodeInfo.jsp","CodeNo="+sCodeNo+"&ItemNo="+sItemNo,"_self","");
	}
