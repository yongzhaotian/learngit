<%@ page contentType="text/html; charset=GBK"%><%@
 include file="/IncludeBegin.jsp"%><%
	...
	String sTempletNo = "OfficeTelBlackListList";//模型编号
...
<script type="text/javascript">
	function newRecord(){
		AsControl.OpenView("/SystemManage/CustomerFinanceManage/OfficeTelBlackListInfo.jsp","","_self","");
	}
	...
	function viewAndEdit(){
		...
		AsControl.OpenView("/SystemManage/CustomerFinanceManage/OfficeTelBlackListInfo.jsp","SerialNo="+sSerialNo,"_self","");
	}
	function importRecords(){
	    ...
	    +",BlackListModel=OfficeTelBlackList"+",BlackListColumn=tel");
		
		//处理导入了重复的数据
		RunMethod("BlackListModel","delMulti","OfficeTelBlackList,Tel");
		reloadSelf();
	}
