<%@ page contentType="text/html; charset=GBK"%><%@
 include file="/IncludeBegin.jsp"%><%
	/*
		页面说明:示例模块主页面
	 */
	String PG_TITLE = "错误类型维护主界面"; // 浏览器窗口标题 <title> PG_TITLE </title>
	String PG_CONTENT_TITLE = "&nbsp;&nbsp;错误类型代码维护&nbsp;&nbsp;"; //默认的内容区标题
	...
	//定义Treeview
	HTMLTreeView tviTemp = new HTMLTreeView(SqlcaRepository,CurComp,sServletURL,"错误类型维护主界面","right");
	...
	tviTemp.insertPage("root","错误类型代码维护","",1);
	tviTemp.insertPage("root","错误类型维护","",2);
...
<script type="text/javascript"> 
	...
	function initTreeView(){
		...
		expandNode('root');
		selectItemByName("错误类型代码维护");	//默认打开的(叶子)选项	
	}
