...
<%
	...
	String sTempletNo = "QualityFileInfo";//模型编号
...
<script type="text/javascript">
	...
	function changeValue(){
		...
		if(a==1||a==2){//alert("为关键与非关键时，下面3个下拉框必填！");
			...
			setItemReadOnly(0,getRow(),"ITEMNAME",false);//设置可填
			...
			setItemReadOnly(0,getRow(),"ITEMNAME",true);//设置不可填

			setItemRequired(0,getRow(),"ITEMNAME",0);//设置非必填项
			setItemRequired(0,getRow(),"Attribute5",0);//设置非必填项
