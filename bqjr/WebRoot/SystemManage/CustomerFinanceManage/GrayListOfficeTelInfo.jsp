...
<script type="text/javascript">
	...
	function saveRecord(sPostEvents){
		...
		//if (typeof(sTEL)!="undefined" && sTEL.length!=0){
			var sCnt=RunMethod("GrayList_MODEL","checkMulti","GrayListOfficeTel,TEL,"+sTEL+","+sSERIALNO);
			if(sCnt>0){
				alert("列表中已有重复的办公电话记录,请重新输入");
	...
	function goBack(){
		AsControl.OpenView("/SystemManage/CustomerFinanceManage/GrayListOfficeTel.jsp","","_self");
	}
