<%@ page contentType="text/html; charset=GBK"%><%@
 include file="/IncludeBegin.jsp"%><%
	...
	String sTempletNo = "PhoneBlackListList";//模型编号
...
<script type="text/javascript">
	function newRecord(){
		AsControl.OpenView("/SystemManage/CustomerFinanceManage/PhoneBlackListInfo.jsp","","_self","");
	}
	...
	function viewAndEdit(){
		...
		AsControl.OpenView("/SystemManage/CustomerFinanceManage/PhoneBlackListInfo.jsp","SerialNo="+sSerialNo,"_self","");
	}
	function importRecords(){
	    ...
	    +",BlackListModel=PhoneBlackList"+",BlackListColumn=phone");
		//处理导入了重复的数据
		RunMethod("BlackListModel","delMulti","PhoneBlackList,Phone");
		reloadSelf();
	}
