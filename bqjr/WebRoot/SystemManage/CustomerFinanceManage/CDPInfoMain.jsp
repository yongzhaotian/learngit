<%@ page contentType="text/html; charset=GBK"%><%@
 include file="/IncludeBegin.jsp"%><%
	/*
		--页面说明:示例模块主页面--
	 */
	String PG_TITLE = "CPD滞纳金配置主页面"; // 浏览器窗口标题 <title> PG_TITLE </title>
	...
	tviTemp.insertPage("root","CPD参数配置","",1);
...
<script type="text/javascript"> 
	function TreeViewOnClick(){
		...
		if(sCurItemname=='CPD参数配置'){
			AsControl.OpenView("/SystemManage/CustomerFinanceManage/CDPInfo.jsp","","right");
		}/* else if(sCurItemname=='我的示例信息'){
			AsControl.OpenView("/Blank.jsp","");
	...
	function initTreeView(){
		...
		//expandNode('root');
		selectItemByName("CPD参数配置");	//默认打开的(叶子)选项	
	}
