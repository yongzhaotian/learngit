<%@ page contentType="text/html; charset=GBK"%><%@
 include file="/IncludeBegin.jsp"%><%
	/*
		页面说明:示例模块主页面
	 */
	String PG_TITLE = "白名单管理"; // 浏览器窗口标题 <title> PG_TITLE </title>
	String PG_CONTENT_TITLE = "&nbsp;&nbsp;白名单管理&nbsp;&nbsp;"; //默认的内容区标题
	...
	tviTemp.insertPage("root","客户白名单","",1);
	//tviTemp.insertPage("root","雇主白名单","",2);
	//tviTemp.insertPage("root","手机号码白名单","",3);
	//tviTemp.insertPage("root","办公电话白名单","",4);
	//tviTemp.insertPage("root","家庭电话白名单","",5);
	//tviTemp.insertPage("root","地址白名单","",6);
...
<script type="text/javascript"> 
	...
	function initTreeView(){
		...
		expandNode('root');
		selectItemByName("客户白名单");	//默认打开的(叶子)选项	
	}
