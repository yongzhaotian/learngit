<%@ page contentType="text/html; charset=GBK"%><%@
 include file="/IncludeBegin.jsp"%><%
	...
	String sTempletNo = "EmployerBlackListList";//模型编号
...
<script type="text/javascript">
	function newRecord(){
		AsControl.OpenView("/SystemManage/CustomerFinanceManage/EmployerBlackListInfo.jsp","","_self","");
	}
	...
	function viewAndEdit(){
		...
		AsControl.OpenView("/SystemManage/CustomerFinanceManage/EmployerBlackListInfo.jsp","SerialNo="+sSerialNo,"_self","");
	}
	function importRecords(){
		...
		RunJavaMethodSqlca("com.amarsoft.app.billions.ExcelDataImport", "importBlackListModel", "filePath="+sFilePath+",userid="+"<%=CurUser.getUserID()%>"+",orgid="+"<%=CurUser.getOrgID()%>"+",inputdate="+"<%=StringFunction.getTodayNow()%>"
	    +",BlackListModel=EmployerBlackList"+",BlackListColumn=companyname");
		
		//处理导入了重复的数据
		   RunMethod("BlackListModel","delMulti","EmployerBlackList,CompanyName");
		reloadSelf();
	}
