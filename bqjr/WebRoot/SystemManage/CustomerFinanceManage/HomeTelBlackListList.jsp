<%@ page contentType="text/html; charset=GBK"%><%@
 include file="/IncludeBegin.jsp"%><%
	...
	String sTempletNo = "HomeTelBlackListList";//模型编号
...
<script type="text/javascript">
	function newRecord(){
		AsControl.OpenView("/SystemManage/CustomerFinanceManage/HomeTelBlackListInfo.jsp","","_self","");
	}
	...
	function viewAndEdit(){
		...
		AsControl.OpenView("/SystemManage/CustomerFinanceManage/HomeTelBlackListInfo.jsp","SerialNo="+sSerialNo,"_self","");
	}
	function importRecords(){
	    ...
	    +",BlackListModel=HomeTelBlackList"+",BlackListColumn=tel");
		
		//处理导入了重复的数据
		RunMethod("BlackListModel","delMulti","HomeTelBlackList,Tel");
