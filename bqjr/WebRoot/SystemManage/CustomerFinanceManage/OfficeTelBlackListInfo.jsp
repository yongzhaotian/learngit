...
<%
	...
	String sTempletNo = "OfficeTelBlackListInfo";//模型编号
...
<script type="text/javascript">
	...
	function saveRecord(sPostEvents){
		...
		if (typeof(sTel)!="undefined" && sTel.length!=0){
			var sCnt=RunMethod("BlackListModel","checkMulti","OfficeTelBlackList,Tel,"+sTel);
			if(sCnt!="Null"){
				alert("列表中已有重复的办公电话号码记录,请重新输入");
	...
	function goBack(){
		AsControl.OpenView("/SystemManage/CustomerFinanceManage/OfficeTelBlackListList.jsp","","_self");
	}
	...
	function initRow(){
		if (getRowCount(0)==0){//如当前无记录，则新增一条
			as_add("myiframe0");
			var sSerialNo = getSerialNo("OfficeTelBlackList","SerialNo");// 获取流水号
