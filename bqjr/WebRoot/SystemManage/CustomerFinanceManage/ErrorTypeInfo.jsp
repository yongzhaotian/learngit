...
<%
	...
	String sTempletNo = "ErrorTypeInfo";//模型编号
...
<script type="text/javascript">
	...
	function checkItemNo() {
		...
		var ssItNo = RunMethod("公用方法", "GetColValue", "code_library,itemNo,itemNo='"+sNo+"' and codeNo='ErrorType' ");
		if (ssItNo!="Null" && ssItNo!=null && ssItNo!="null" && ssItNo!="") {
			alert("该代码项编号已经存在，请重新输入！");
	...
	function goBack(){
		AsControl.OpenView("/SystemManage/CustomerFinanceManage/ErrorTypeList.jsp","","_self");
	}

	<%/*~[Describe=执行插入操作前执行的代码;]~*/%>
	function beforeInsert(){
		setItemValue(0, 0, "CodeNo", "ErrorType");
