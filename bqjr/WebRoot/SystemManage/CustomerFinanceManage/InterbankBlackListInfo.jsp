...
<%
	...
	String sTempletNo = "InterbankBlackListInfo";//模型编号
...
<script type="text/javascript">
	...
	function saveRecord(sPostEvents){
		...
		if (typeof(sCardNo)!="undefined" && sCardNo.length!=0){
			var sCnt=RunMethod("BlackListModel","checkMulti","InterbankBlackList,CardNo,"+sCardNo);
			if(sCnt!="Null"){
	...
	function goBack(){
		AsControl.OpenView("/SystemManage/CustomerFinanceManage/InterbankBlackListList.jsp","","_self");
	}
	...
	function initRow(){
		if (getRowCount(0)==0){//如当前无记录，则新增一条
			as_add("myiframe0");
			var sSerialNo = getSerialNo("InterbankBlackList","SerialNo");// 获取流水号
