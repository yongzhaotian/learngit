<%@ page contentType="text/html; charset=GBK"%><%@
 include file="/IncludeBegin.jsp"%><%
	...
	String sTempletNo = "NearCityList";//模型编号
...
<script type="text/javascript">
	...
	function newRecord(){
		AsControl.OpenView("/SystemManage/CustomerFinanceManage/NearCityInfo.jsp","","_self","");
	}
	...
	function viewAndEdit(){
		...
		AsControl.OpenView("/SystemManage/CustomerFinanceManage/NearCityInfo.jsp","SerialNo="+sSerialNo,"_self","");
	}
