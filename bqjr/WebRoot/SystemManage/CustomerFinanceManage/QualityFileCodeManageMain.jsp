...
<%/*~END~*/%>
 <%
	/*
		页面说明:示例模块主页面
	 */
	String PG_TITLE = "文件名称维护"; // 浏览器窗口标题 <title> PG_TITLE </title>
	String PG_CONTENT_TITLE = "&nbsp;&nbsp;文件名称维护&nbsp;&nbsp;"; //默认的内容区标题
	...
	//定义Treeview
	HTMLTreeView tviTemp = new HTMLTreeView(SqlcaRepository,CurComp,sServletURL,"文件名称维护","right");
	...
	tviTemp.insertPage("root","文件名称维护","",1);
...
<script type="text/javascript"> 
	...
	function initTreeView(){
		...
		expandNode('root');
		selectItemByName("文件名称维护");	//默认打开的(叶子)选项	
	}
