<%@ page contentType="text/html; charset=GBK"%><%@
 include file="/IncludeBegin.jsp"%><%
	/*
		页面说明:灰名单管理模块主页面
	 */
	String PG_TITLE = "灰名单管理"; // 浏览器窗口标题 <title> PG_TITLE </title>
	String PG_CONTENT_TITLE = "&nbsp;&nbsp;灰名单管理&nbsp;&nbsp;"; //默认的内容区标题
	...
	//定义Treeview
	HTMLTreeView tviTemp = new HTMLTreeView(SqlcaRepository,CurComp,sServletURL,"灰名单管理","right");
	...
	tviTemp.insertPage("root","手机号码灰名单","",1);
	tviTemp.insertPage("root","单位名称灰名单","",2);
	tviTemp.insertPage("root","单位地址灰名单","",3);
	tviTemp.insertPage("root","家庭电话灰名单","",4);
	tviTemp.insertPage("root","办公电话灰名单","",5);
	tviTemp.insertPage("root","家庭地址灰名单","",6);
...
<script type="text/javascript"> 
	...
	function initTreeView(){
		...
		expandNode('root');
		selectItemByName("手机号码灰名单");	//默认打开的(叶子)选项
	}
