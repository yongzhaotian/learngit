<%@ page contentType="text/html; charset=GBK"%><%@
 include file="/IncludeBegin.jsp"%><%
	...
	String sTempletNo = "AuditCategoryList";
...
<script type="text/javascript">
	...
	function mySelectRow(){
		...
		if(typeof(sFlowNo)=="undefined" || sFlowNo.length==0) {
			...
			AsControl.OpenView("/SystemManage/CarManage/AuditModelList.jsp","FlowNo="+sFlowNo,"rightdown","");
		}
	}
	
	function newRecord(){
		AsControl.OpenView("/SystemManage/CarManage/AuditCategoryInfo.jsp","","_self","");
	}
	...
	function viewAndEdit(){
		...
		AsControl.OpenView("/SystemManage/CarManage/AuditCategoryInfo.jsp","FlowNo="+sFlowNo,"_self","");
	}
