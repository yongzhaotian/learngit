...
<%
	...
	if(sTypeCode==null) sTypeCode="InnerEmployee";
	
	
	// 通过DW模型产生ASDataObject对象doTemp
	String sTempletNo = "InnerEmployeeInfo";//模型编号
...
<script type="text/javascript">
	...
	function goBack(){
		AsControl.OpenView("/SystemManage/CarManage/InnerEmployeeList.jsp","","_self");
	}
