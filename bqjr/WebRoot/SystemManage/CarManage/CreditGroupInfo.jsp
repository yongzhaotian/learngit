...
<%
	...
	String sTempletNo = "CreditGroupInfo";//模型编号
...
<script type="text/javascript">
	...
	function goBack(){
		AsControl.OpenView("/SystemManage/CarManage/CreditGroupList.jsp","","_self");
	}
	...
	function initRow(){
		if (getRowCount(0)==0){//如当前无记录，则新增一条
			as_add("myiframe0");
			var sSerialNo = getSerialNo("CreditGroup","SerialNo");// 获取流水号
