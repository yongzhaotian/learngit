<%@ page contentType="text/html; charset=GBK"%><%@
 include file="/IncludeBegin.jsp"%><%
	...
	String sTempletNo = "CreditGroupList";//模型编号
...
<script type="text/javascript">
	function newRecord(){
		AsControl.OpenView("/SystemManage/CarManage/CreditGroupInfo.jsp","","_self","");
	}
	...
	function viewAndEdit(){
		...
		AsControl.OpenView("/SystemManage/CarManage/CreditGroupInfo.jsp","SerialNo="+sSerialNo,"_self","");
	}
