<%@ page contentType="text/html; charset=GBK"%><%@
 include file="/IncludeBegin.jsp"%><%
	...
	String sTempletNo = "FeeAuditModelList";//模型编号
...
<script type="text/javascript">
	function newRecord(){
		...
		AsControl.OpenView("/SystemManage/CarManage/FeeAuditModelInfo.jsp","FlowNo=<%=sFlowNo %>","_self","");
	}
	...
	function viewAndEdit(){
		...
		AsControl.OpenView("/SystemManage/CarManage/FeeAuditModelInfo.jsp","FlowNo=<%=sFlowNo%>&PhaseNo='"+sPhaseNo+"'&ActionType=ViewDetail","_self","");
	}
