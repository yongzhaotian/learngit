<%@ page contentType="text/html; charset=GBK"%><%@
 include file="/IncludeBegin.jsp"%><%
	/*
		页面说明:示例模块主页面
	 */
	String PG_TITLE = "审核人员权限配置"; // 浏览器窗口标题 <title> PG_TITLE </title>
	String PG_CONTENT_TITLE = "&nbsp;&nbsp;审核人员权限配置&nbsp;&nbsp;"; //默认的内容区标题
	...
	//定义Treeview
	HTMLTreeView tviTemp = new HTMLTreeView(SqlcaRepository,CurComp,sServletURL,"审核人员权限配置","right");
	...
	tviTemp.insertPage("root","审核人员权限配置","",1);
...
<script type="text/javascript"> 
	...
	function initTreeView(){
		...
		expandNode('root');
		selectItemByName("审核人员权限配置");	//默认打开的(叶子)选项	
	}
