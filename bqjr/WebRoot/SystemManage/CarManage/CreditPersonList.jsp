<%@ page contentType="text/html; charset=GBK"%><%@
 include file="/IncludeBegin.jsp"%><%
	...
	String sTempletNo = "CreditPersonList";//模型编号
	...
	String sButtons[][] = {
		...
		{"true","","Button","详情","详情查看","viewAndEdit()",sResourcesPath},
...
<script type="text/javascript">
	function newRecord(){
		AsControl.OpenView("/SystemManage/CarManage/CreditPersonInfo.jsp","","_self","");
	}
	...
	function viewAndEdit(){
		...
		AsControl.OpenView("/SystemManage/CarManage/CreditPersonInfo.jsp","SerialNo="+sSerialNo,"_self","");
	}
