...
<%
	...
	String sTypeCode =  DataConvert.toRealString(iPostChange,(String)CurComp.getParameter("TypeCode"));
	if(sTypeCode==null) sTypeCode="RiskCustomer";
	
	// 通过DW模型产生ASDataObject对象doTemp
	String sTempletNo = "RiskCustomerInfo";//模型编号
...
<script type="text/javascript">
	...
	function goBack(){
		AsControl.OpenView("/SystemManage/CarManage/RiskCustomerList.jsp","","_self");
	}
