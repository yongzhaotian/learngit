...
<script type="text/javascript">
	function newRecord(){
		...
		AsControl.OpenView("/SystemManage/CarManage/AuditModelInfo.jsp","FlowNo=<%=sFlowNo %>","_self","");
	}
	...
	function viewAndEdit(){
		...
		AsControl.OpenView("/SystemManage/CarManage/AuditModelInfo.jsp","FlowNo=<%=sFlowNo%>&PhaseNo='"+sPhaseNo+"'&ActionType=ViewDetail","_self","");
	}
