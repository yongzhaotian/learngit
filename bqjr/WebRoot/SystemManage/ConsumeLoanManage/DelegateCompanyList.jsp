<%@ page contentType="text/html; charset=GBK"%><%@
 include file="/IncludeBegin.jsp"%><%
	...
	String sTempletNo = "DelegateCompanyList";//模型编号
...
<script type="text/javascript">
	 /*~[Describe=记录被选中的触发时间;InputParam=无;OutPutParam=无;]~*/
	...
	function deleteRecord(){
		...
		if(confirm("您真的想删除该信息吗？")){
			as_del("myiframe0");
			// 级联删除委外公司关联城市
			RunMethod("公用方法", "DelByWhereClause", "DELEGATECOMPANY_RELATIVE,ObjectNo='"+sSerialNo+"'");
