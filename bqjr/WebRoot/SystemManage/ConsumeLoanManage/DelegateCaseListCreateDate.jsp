...
<%
	...
	// 获得序列号
	String sSerialNo = Sqlca.getString("select SerialNo from BasedataSet_Info where TypeCode='"+
				sTypeCode+"' order by SerialNo desc");
	if (sSerialNo == null) sSerialNo = "";
	
	// 通过DW模型产生ASDataObject对象doTemp
	String sTempletNo = "DelegateCaseListCreateDateInfo";//模型编号
...
<script type="text/javascript">
	...
	function goBack(){
		...
		AsControl.OpenView("/SystemManage/ConsumeLoanManage/CollectionFlowList.jsp","","_self");
	}
