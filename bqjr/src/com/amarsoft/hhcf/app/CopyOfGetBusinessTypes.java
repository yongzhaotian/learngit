...
public class CopyOfGetBusinessTypes extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String sProductID =  request.getParameter("ProductID");							// 产品类型
		String sProductSum =  request.getParameter("ProductSum");					// 	产品金额	
		String sShoufuratio =  request.getParameter("Shoufuratio");						// 首付比例
		String sProductCategory =  request.getParameter("ProductCategory");		// 	商品范畴
		String sSNo =  request.getParameter("SNo");											// 门店编号
