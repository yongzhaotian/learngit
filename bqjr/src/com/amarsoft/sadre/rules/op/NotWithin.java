...
import javax.naming.OperationNotSupportedException;
 ...
 /**
 * <p>Title: NotWithin.java </p>
 * <p>Description:  </p>
 * <p>Copyright: Copyright (C) 2006-2011 Amarsoft Ltd. Co.</p> 
 *     
 * @author zllin@amarsoft.com
 * @version 
 * @date 2011-4-21 下午05:09:28
 *
 * logs: 1. 
 */
public class NotWithin implements Operator {
	...
	public boolean validateString(String source, String target) throws OperationNotSupportedException{
		...
		for(int src=0; src<arraySource.length; src++){		//任何一个src都不存在于dest中
			...
			if(exists){			//一旦src存在于dest中,则结束所有判断
				valIn = false;
				break;
			}
		}
	...
	public boolean validateNumber(double source, double target) throws OperationNotSupportedException{
		throw new OperationNotSupportedException("精度数不支持'notin'操作");
	}
	...
	public boolean validateInteger(int source, int target) throws OperationNotSupportedException{
		throw new OperationNotSupportedException("整数不支持'notin'操作");
	}
	...
	public boolean validateBoolean(boolean source, boolean target) throws OperationNotSupportedException{
		throw new OperationNotSupportedException("布尔不支持'notin'操作");
	}
