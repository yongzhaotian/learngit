...
public class PutApplyProductParamCheck extends AlarmBiz {
	...
	public Object run(Transaction Sqlca) throws Exception {
		...
		BusinessObject businessApply = bom.loadObjectWithKey(BUSINESSOBJECT_CONSTATNTS.business_putout, sSerialNo);
