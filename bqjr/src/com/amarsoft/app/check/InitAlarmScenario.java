 ...
 *
 */
public class InitAlarmScenario extends Bizlet{
	...
	public Object run(Transaction Sqlca) throws Exception {
		...
		Parser.registerFunction("GETERATE");
		...
		BizObject jboApply = getApply(sApplyNo);
	...
	/**
	 * 初始化业务申请
	 * @param sApplyNo 业务申请申请号
	 * @return
	 * @throws Exception
	 */
	public BizObject getApply(String sApplyNo) throws Exception{
