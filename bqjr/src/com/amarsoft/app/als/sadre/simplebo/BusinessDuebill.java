...
import com.amarsoft.sadre.SADREException;
 ...
 /**
 * <p>Title: BusinessDuebill.java </p>
 * <p>Description:  </p>
 * <p>Copyright: Copyright (C) 2011-2015 Amarsoft Ltd. Co.</p> 
 *     
 * @author hwang@amarsoft.com
 * @version 
 * @date 2012-11-28 下午4:13:59
 *
 * logs: 1. 
 */
public class BusinessDuebill implements ISimpleBO {
	/*客户类私有变量*/
	...
	/*业务类私有变量*/
	private String applySerialNo = "";		//业务申请流水号
	...
	public BusinessDuebill(String serialNo, Transaction to){
		this.applySerialNo = serialNo;
		this.Sqlca = to;
	}
	...
	public void fullfill() throws SADREException {
		try {
			ASResultSet resultset = Sqlca.getASResultSet("select CustomerId,CustomerName,BusinessType,getBusinessName(BusinessType) as BusinessName," +
					...
					"from BUSINESS_APPLY where SERIALNO='"+getApplySerialNo()+"'");
			if(resultset.next()){
