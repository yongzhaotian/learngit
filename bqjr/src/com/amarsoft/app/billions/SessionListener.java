...
public class SessionListener implements HttpSessionBindingListener,
	...
	public SessionListener(HttpServletRequest Req, HttpSession HS,
			ASUser curUser, String sDataSource) {
	...
	public SessionListener(HttpServletRequest Req, HttpSession HS,
			ASUser curUser, String sDataSource, String sClientIP) {
		this.sServerName = Req.getServerName();
		this.sServerPort = String.valueOf(Req.getServerPort());
		this.sSessionID = HS.getId();
		if (sClientIP != null) {
	...
	public SessionListener(HttpServletRequest Req, HttpSession HS,
			ASUser curUser, String sDataSource, ServletContext application) {
		this.sServerName = Req.getServerName();
		this.sServerPort = String.valueOf(Req.getServerPort());
		this.sSessionID = HS.getId();
		this.sRemoteAddr = Req.getRemoteAddr();
	...
	public void valueBound(HttpSessionBindingEvent event) {
		...
		try {
			...
			Sqlca = null;
			ARE.getLog().info(
					"SessionListener:Logon Session[" + this.sSessionID
							+ "] User[" + this.sUserID + "] UserName["
							+ this.sUserName + "]");
		} catch (Exception e) {
	...
	public void valueUnbound(HttpSessionBindingEvent event) {
		...
		try {
			...
			if (userMap!=null) userMap.remove(sUserID);
			ARE.getLog().info(
					"SessionListener:Logout Session[" + this.sSessionID
							+ "] User[" + this.sUserID + "] UserName["
							+ this.sUserName + "]");
		} catch (Exception e) {
