...
public class SubJudgeCurrency extends Bizlet {
	...
	public Object run(Transaction Sqlca) throws Exception {
        ...
        sSql = "select BusinessCurrency,(BusinessSum-BailSum)*getERate(BusinessCurrency,'01','') "+
        ...
        rs = Sqlca.getASResultSet(new SqlObject(sSql).setParameter("LimitationSetID", sLimitationSetID).setParameter("LimObjectNo", sCurrency));
        if(rs.next())
        { 
