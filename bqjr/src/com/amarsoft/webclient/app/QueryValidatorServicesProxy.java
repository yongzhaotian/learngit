...
public class QueryValidatorServicesProxy implements com.amarsoft.webclient.app.QueryValidatorServices {
  private String _endpoint = null;
  private com.amarsoft.webclient.app.QueryValidatorServices queryValidatorServices = null;
  ...
  private void _initQueryValidatorServicesProxy() {
    try {
      queryValidatorServices = (new com.amarsoft.webclient.app.QueryValidatorServicesServiceLocator()).getQueryValidatorServices();
  ...
  public com.amarsoft.webclient.app.QueryValidatorServices getQueryValidatorServices() {
    if (queryValidatorServices == null)
      _initQueryValidatorServicesProxy();
