...
package com.amarsoft.webclient.app;

public class QueryValidatorServicesServiceLocator extends org.apache.axis.client.Service implements com.amarsoft.webclient.app.QueryValidatorServicesService {
    ...
    public com.amarsoft.webclient.app.QueryValidatorServices getQueryValidatorServices() throws javax.xml.rpc.ServiceException {
    ...
    public com.amarsoft.webclient.app.QueryValidatorServices getQueryValidatorServices(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.amarsoft.webclient.app.QueryValidatorServicesSoapBindingStub _stub = new com.amarsoft.webclient.app.QueryValidatorServicesSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.amarsoft.webclient.app.QueryValidatorServices.class.isAssignableFrom(serviceEndpointInterface)) {
                com.amarsoft.webclient.app.QueryValidatorServicesSoapBindingStub _stub = new com.amarsoft.webclient.app.QueryValidatorServicesSoapBindingStub(new java.net.URL(QueryValidatorServices_address), this);
                _stub.setPortName(getQueryValidatorServicesWSDDServiceName());
                return _stub;
            }
        }
